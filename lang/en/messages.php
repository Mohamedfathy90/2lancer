<?php
    ...
    return [
        ...
        "t_follow_us_on_tiktok"                                    => "Follow us on TikTok",
        ...
        "t_project_updated_successfully"                           => "Project has been successfully updated",
        ...
        "t_tiktok_page"                                            => "Tiktok page",
        "t_enter_tiktok_page_link"                                 => "Enter TikTok page link",
        ...
        "t_verification_document_ID"                               => "Verification Document ID",
        ...
        "t_cashback_settings"                                      => "Cashback Settings",
        "t_enable_cashback"                                        => "Enable Cashback",
        "t_cashback_percentage"                                    => "Cashback Percentage",
        ...
        "t_subject_admin_refund_dispute_raised"                    => "Refund dispute raised",
        "t_hi_admin"                                               => "Hi admin!",
        ...
        "t_mollie_payment_pending"                                 => "Your payment is now being confirmed, We will update it automatically soon.",
        ...
        "t_buyer_story_1"                                          => "2LANCER is an amazing resource for anyone in the startup space.",
        "t_buyer_story_2"                                          => "People love our logo, and we love 2LANCER.",
        "t_buyer_story_3"                                          => "There is no way I could have produced anything without 2LANCER.",
        ...
        "t_how_much_money_can_i_make_answer"                       => "It's totally up to you. You can work as much as you want. Many sellers work on 2LANCER full time and some keep their 9-5 job while using 2LANCER to make extra money.",
        "t_how_much_does_it_cost_question"                         => "How much does it cost?",
        "t_how_much_does_it_cost_answer"                           => "It's free to join 2LANCER. There is no subscription required or fees to list your services. You keep 70% of each transaction.",
        ...
        "t_how_do_i_price_my_service_answer"                       => "You can set your pricing anywhere from 50DH - 50.000DH and offer your service to buyers.",
        "t_how_do_i_get_paid_question"                             => "How do I get paid?",
        "t_how_do_i_get_paid_answer"                               => "the money is transferred to your account. Or to your credit card.",
        ...
        "t_type_something_to_start_messaging"                      => '',
        ...
        "t_max_allowed_skills_reached"                             => "Maximum allowed skills reached",
        "t_enter_amount_u_like_to_deposit"                         => "Enter the amount you would like to deposit",
        "t_min_deposit_amount_is_and_max_is"                       => "The minimum deposit amount is :min and maximum is :max",
        
        "t_FAQ"                                                    => "FAQs",		
        "t_contact us"                                             => " Contact us",
        "t_work with us"                                           => " Work with us",
        "t_collaboration"                                          => "collaboration",
        "t_Garanties"                                              => "Guarantees",
        "t_Les Conditions générales de ventes"                     => " General conditions of sale",
        "t_Politique de confidentialité"                           => " Privacy Policy",
        "t_STE : EAG LUX SARL AU"                                  => "STE : EAG LUX SARL AU",
        "t_Adresse : N°72, Boulevard MARCHE VERT BIS ESSMARA MAROC"=> "ADDRESS : N°72, Boulevard MARCHE VERT BIS ESSMARA MAROC",
        "t_TEL : +212528233224"                                    => "TEL : +212528233224" ,
        "t_support@2lancer.ma"                                     => "support@2lancer.ma" ,

        "t_admin_management"                                       => "Admin Management",
        "t_roles_permissions"                                      => "Roles & Permissions",
        "t_registered_admins"                                      => "Registered Admins",
        "t_role_name"                                              => "Role Name" ,
        "t_role_permissions"                                       => "Role Permissions" ,
        "t_add_role"                                               => "Add Role" ,
        "t_edit_role"                                              => "Edit Role" ,
        "t_delete_role"                                            => "Delete Role" ,
        "t_add_role"                                               => "Add Role" ,
        "t_email"                                                  => "Email" ,
        "t_role"                                                   => "Role" ,
        "t_add_permission"                                         => "Add Permission" ,
        "t_create_role"                                            => "Create Role" ,
        "t_enter_role_name"                                        => "Enter Role Name" ,
        "t_permissions_related_to_role"                            => "Select permissions related to role ",
        "t_enter_permission_name"                                  => "Enter Permission Name ",
        "t_permission_name"                                        => "Permission Name",
        "t_create_permission"                                      => "Create Permission",
        "t_add_admin"                                              => "Add Admin",
        "t_not_active"                                             => "Not Active",
        "t_edit_admin"                                             => "Edit Admin",
        "t_delete_admin"                                           => "Delete Admin",
        "t_registered_admins"                                      => "Registered Admins",
        "t_choose_admin_role"                                      => "Choose Admin Role",
        "t_select_role"                                            => "Select Role",
        "t_are_u_sure_u_want_to_delete_role"                       => "Are you sure you want to delete this role ?" ,
        "t_are_u_sure_u_want_to_delete_admin"                      => "Are you sure you want to delete this admin ?",
        "t_Data"                                                   => "Data",
        "t_Lifestyle"                                              => "Lifestyle",
        "t_Business"                                               => "Business",
        "t_Programming & Tech"                                     => "Programming & Tech",
        "t_Music & Audio"                                          => "Music & Audio",
        "t_Video & Animation"                                      => "Video & Animation",
        "t_Writing & Translation"                                  => "Writing & Translation",
        "t_Digital Marketing"                                      => "Digital Marketing",
        "t_Graphics & Design"                                      => "Graphics & Design" , 
        "t_Data Entry"                                             => "Data Entry" ,
        "t_Databases"                                              => "Databases" ,
        "t_Data Analytics"                                         => "Data Analytics" , 
        "t_Data Science"                                           => "Data Science" , 
        "t_Data Engineering"                                       => "Data Engineering" , 
        "t_Self Improvement"                                       => "Self Improvement" ,
        "t_Leisure & Hobbies"                                      => "Leisure & Hobbies" ,
        "t_Wellness & Fitness"                                     => "Wellness & Fitness" ,
        "t_Gaming"                                                 => "Gaming" ,
        "t_On-Camera Talent"                                       => "On-Camera Talent" ,
        "t_General and Administrative"                             => "General & Adminstrative" ,
        "t_Sales & Customer Care"                                  => "Sales & Customer Care" ,
        "t_Miscellaneous"                                          => "miscellaneous" ,
        "t_Website Development"                                    => "Website Development" ,
        "t_Application Development"                                => "Application Development" ,
        "t_Support & Cybersecurity"                                => "Support & Cybersecurity" ,
        "t_User Testing"                                           => "User Testing" ,
        "t_Sound Design"                                           => "Sound Design" ,
        "t_Lessons & Transcription"                                => "Lessons & Transcription" ,
        "t_Voice Over & Streaming"                                 => "Voice Over & Streaming" ,
        "t_Audio Engineering & Post Production"                    => "Audio Engineering & Post Production" ,
        "t_Music Production & Writing"                             => "Music Production & Writing" ,
        "t_DJing"                                                  => "DJing" ,
        "t_Tutorials & Education"                                  => "Tutorials & Education" ,
        "t_Photography"                                            => "Photography" ,
        "t_Animation"                                              => "Animation" ,
        "t_Product & Explainer Videos"                             => "Product & Explainer Videos" ,
        "t_Video Editing & Post-Production"                        => "Video Editing & Post-Production" ,
        "t_Social & Marketing Videos"                              => "Social & Marketing Videos" ,
        "t_Sales & Marketing Copy"                                 => "Sales & Marketing Copy" ,
        "t_Translation & Transcription"                            => "Translation & Transcription" ,
        "t_Storytelling"                                           => "Storytelling" ,
        "t_Career Writing"                                         => "Career Writing" ,
        "t_Business Copy"                                          => "Business Copy" ,
        "t_Content Writing & Editing"                              => "Content Writing & Editing" ,
        "t_Analytics & Strategy"                                   => "Analytics & Strategy" ,
        "t_Industry & Purpose-specific"                            => "Industry & Purpose-specific" ,
        "t_Content"                                                => "Content" ,
        "t_Advertising"                                            => "Advertising" ,
        "t_Social"                                                 => "Social" ,
        "t_Search"                                                 => "Search" ,
        "t_Print Design"                                           => "Print Design" ,
        "t_Visual Design"                                          => "Visual Design" ,
        "t_Marketing Design"                                       => "Marketing Design" ,
        "t_Art & Illustration"                                     => "Art & Illustration" ,
        "t_Web & App Design"                                       => "Web & App Design" ,
        "t_Logo & Brand Identity"                                  => "Logo & Brand Identity" ,
        "t_Intermediate Buyer"                                     => "Intermediate Buyer" ,
        "t_Intermediate Seller"                                    => "Intermediate Seller" ,
        "t_New Buyer"                                              => "New Buyer" ,
        "t_New Seller"                                             => "New Seller" ,
        "t_Pro Buyer"                                              => "Pro Buyer" ,
        "t_Pro Seller"                                             => "Pro Seller" ,
        "t_Top Rated Seller"                                       => "Top Rated Seller" ,
        "t_Top Rated Buyer"                                        => "Top Rated Buyer" ,
        "t_view_conversation"                                      => "View Conversation" ,
        "t_conversation_members"                                   => "Conversation Members" ,
        "t_are_u_sure_u_want_to_delete_this_conv"                  => "Are you sure you want to delete this conversation?",
        "t_affiliate"                                              => "Affiliate",
        "t_affiliate_settings"                                     => "Affiliate Settings",
        "t_affiliate_statistics"                                   => "Affiliate Statistics",
        "t_affiliate_settings_subtitle"                            => "Update your affiliate settings",
        "t_referral_link"                                          => "Referral Link",
        "t_clicks_number"                                          => "Number of Clicks",
        "t_registerations_number"                                  => "Number of Registerations",
        "t_transaction_date"                                       => "Transaction Date",
        "t_your_earning"                                           => "profit added to your wallet",
        "t_affiliate_transactions"                                 => "Earning from Affiliate",
        "t_affiliate_settings_sidebar"                             => "Affiliate",
        "t_payment_gateway"                                        => "Payment Gateway",
        "t_enable_affiliate"                                       => "Enable Affiliate",
        "t_profit_percentage"                                      => "Profit Percentage" ,
        "t_expiry_months"                                          => "Expiry Months for registeration",
        "t_payment_gateways"                                       => "Payment Gateways",
        "t_edit_admin"                                             => "Edit Admin" ,
        "t_delete_admin"                                           => "delete Admin" ,
        "t_sms_messages"                                           => "SMS Messages",
        "t_send_sms"                                               => "Send Message",
        "t_select_user"                                            => "Select User",
        "t_sms_settings"                                           => "SMS settings",
        "t_base_url"                                               => "Base_Url",
        ...
        "t_new_cashback_balance"                                   => "Cashback amount  :amount MAD has added to your wallet" ,
        ...
        "t_my_deposits"                                            => "Deposit Transactions"   ,
        ...
        "t_filter_by_status"                                       => "Filter by status" ,
        "t_search_for_gig"                                         => "Search for Gig" ,
        "t_all"                                                    => "All" ,
