            ...
            <table class="w-full text-left border-spacing-y-[10px] border-separate -mt-2">
                ...
                <thead>
                    <?php $__empty_1 = true; $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="admin-dashboard-reported-bids-<?php echo e($r->uid, false); ?>">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-52">
                                <div class="whitespace-nowrap text-sm font-medium text-zinc-700 truncate w-52 block">
                                    <?php echo app('translator')->get('messages.t_report_bid_' . $r->reason); ?>
                                </div>
                            </td>
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                <div class="flex items-center justify-center space-x-4 rtl:space-x-reverse">
                                    ...
                                    <div>
                                        <button type="button" data-tooltip-target="tooltip-actions-preview-<?php echo e($r->uid, false); ?>" id="modal-preview-bid-button-<?php echo e($r->uid, false); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-preview-'.e($r->uid, false).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_preview_bid'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                    ...
                                    <?php if(!$r->is_seen): ?>
                                       <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('bid_report_mark_seen')): ?> 
                                        <div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-preview-bid-container-'.e($r->uid, false).'','target' => 'modal-preview-bid-button-'.e($r->uid, false).'','uid' => 'modal_preview_bid_'.e($r->uid, false).'','placement' => 'center-center','size' => 'max-w-2xl']); ?>
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="mb-8">
                                            ...
                                            <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                                  ...
                                                  <a href="<?php echo e(url('profile', $r->bid->user->username), false); ?>" class="block">
                                                    <img class="rounded-full h-12 w-12 object-cover object-center lazy" src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src($r->bid->user->avatar), false); ?>" alt="<?php echo e($r->bid->user->username, false); ?>">
                                                </a>
                                                ...
                                                <div class="space-y-0.5">
                                                    ...
                                                    <div class="flex items-center">
                                                        ...
                                                        <?php if($r->bid->user->fullname): ?>
                                                            <span class="font-medium text-zinc-900 text-sm hover:text-black ltr:pr-1 rtl:pl-1">
                                                                <?php echo e($r->bid->user->fullname, false); ?>

                                                            </span>
                                                        <?php endif; ?>
                                    
                                                        
                                                        <a href="<?php echo e(url('profile', $r->bid->user->username), false); ?>" class="font-medium text-gray-500 text-[13px] hover:text-primary-600 focus:text-primary-600 inline-flex items-center">
                                                            ...
                                                            <span><?php echo e($r->bid->user->username, false); ?></span>
                                                        </a>
                                                    ...
                                                    <div class="flex items-center space-x-3 rtl:space-x-reverse text-[13px]">
                                                        ...
                                                        <?php if($r->bid->user->country): ?>
                                                            <p class="flex items-center space-x-1 rtl:space-x-reverse">
                                                                <img class="h-4 ltr:pr-0.5 rtl:pl-0.5 -mt-0.5 lazy" src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(countryFlag($r->bid->user->country->code), false); ?>" alt="<?php echo e($r->bid->user->country->name, false); ?>">
                                                                <span><?php echo e($r->bid->user->country->name, false); ?></span>
                                                            </p>
                                                        ...
                                                        <p class="flex shrink-0 items-center space-x-1 rtl:space-x-reverse">
                                                            <svg aria-hidden="true" class="w-4 h-4 <?php echo e($r->bid->user->rating() == 0 ? 'text-gray-400' : 'text-amber-500', false); ?> -mt-0.5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                                                            <span>
                                                                <?php echo e($r->bid->user->rating(), false); ?>

                                                            </span>
                                                        </p>
                                    
                                                        
                                                        <?php if($r->bid->user->status === 'verified'): ?>
                                                            <div class="mx-2 my-0.5 text-gray-300">|</div>
...
</div><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/reports/bids.blade.php ENDPATH**/ ?>