                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="admin-invoices-<?php echo e($i->uid, false); ?>">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                <span class="text-sm font-bold text-zinc-900 tracking-wide"><?php echo money($i->order->total_value, settings('currency')->code, true); ?></span>
                            </td>
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                <div class="flex items-center justify-center space-x-3 rtl:space-x-reverse">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_invoice_details')): ?>
                                    <div>
...
<?php endif; ?>
                                    ...
                                    <?php if($i->status === 'pending' && $i->payment_method === "offline"): ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('approve_invoice')): ?>
                                        <div>
...
</div><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/invoices/invoices.blade.php ENDPATH**/ ?>