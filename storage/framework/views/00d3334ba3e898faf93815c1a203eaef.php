<div class="w-full bg-white shadow rounded-lg">
    ...
    <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            <div class="mb-14">
                <h2 class="text-sm leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_edit_subcategory'), false); ?></h2>
            </div>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(__('messages.t_subcategory_name'), false).'','placeholder' => ''.e(__('messages.t_enter_subcategory_name'), false).'','model' => 'name','icon' => 'format-title']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(__('messages.t_subcategory_slug'), false).'','placeholder' => ''.e(__('messages.t_enter_subcategory_slug'), false).'','model' => 'slug','icon' => 'link-variant']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal0241d3f51813223308810020791c4a83)): ?>
<?php $component = $__componentOriginal0241d3f51813223308810020791c4a83; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(__('messages.t_description'), false).'','placeholder' => ''.e(__('messages.t_enter_description'), false).'','model' => 'description','icon' => 'file-document','rows' => '7']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <?php if($subcategory->icon): ?>
                        <div class="mt-3">
                            <img src="<?php echo e(src( $subcategory->icon ), false); ?>" class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    <?php endif; ?>
                </div>
...
<?php endif; ?>
                    ...
                    <?php if($subcategory->image): ?>
                        <div class="mt-3">
                            <img src="<?php echo e(src( $subcategory->image ), false); ?>" class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    <?php endif; ?>
                </div>
...
</div>    <?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/subcategories/options/edit.blade.php ENDPATH**/ ?>