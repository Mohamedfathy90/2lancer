...
<?php if(isset($actionText)): ?>
 <?php $__env->slot('subcopy', null, []); ?> 
    <?php echo app('translator')->get('messages.t_if_u_have_trouble_click_link_notification', ['actionText' => $actionText]); ?> <span class="break-all">[<?php echo e($displayableActionUrl, false); ?>](<?php echo e($actionUrl, false); ?>)</span>
 <?php $__env->endSlot(); ?>
<?php endif; ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/vendor/notifications/email.blade.php ENDPATH**/ ?>