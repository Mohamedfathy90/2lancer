...
<?php endif; ?>
                ...
                <div class="ltr:ml-3 rtl:mr-3">
                    ...
                    <div class="mt-6">
                        <div class="-mx-2 -my-1.5 flex">
                            ...
                            <a href="<?php echo e(url('https://wa.me/'. config('global.whatsapp') .'/?text=Hello'), false); ?>" target="_blank" class="px-2 py-1.5 text-sm font-medium text-slate-800 focus:outline-none focus:ring-0 flex items-center space-x-1 rtl:space-x-reverse group">
    ...
    <div>
        <h3 class="text-lg font-bold text-gray-900">
            <?php echo e(__('messages.t_plans_for_promoting_projects'), false); ?>

        </h3>
        <p class="mt-1 text-sm font-normal text-gray-500">
            <?php echo e(__('messages.t_projects_subscription_plans_subtitle'), false); ?>
    ...
    <div class="mt-4 space-y-4 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-6 lg:max-w-4xl lg:mx-auto xl:max-w-none xl:mx-0 xl:grid-cols-4 mb-16">
        ...
        <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white border border-gray-200 rounded-lg shadow-sm" wire:key="projects-plans-<?php echo e($s->id, false); ?>">
                <div class="p-6">

                    
                    <h3 class="inline-flex px-4 py-2 rounded-full text-xs font-semibold tracking-wide uppercase" style="color: <?php echo e($s->badge_text_color, false); ?>;background-color: <?php echo e($s->badge_bg_color, false); ?>;">
                        <?php echo e($s->title, false); ?>
                    ...
                    <p class="mt-4 text-sm text-gray-500 h-24 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 dark:scrollbar-thumb-zinc-900 dark:scrollbar-track-zinc-600">
                        <?php echo e($s->description, false); ?>
                    ...
                    <p class="mt-8">
                        <span class="text-3xl font-extrabold text-gray-900 ">
                            <?php echo e(_price($s->price), false); ?>

                        </span>
                        <?php if($s->days): ?>
                            <span class="text-xs font-medium text-gray-500 lowercase">/ <?php echo e($s->days, false); ?> <?php echo e(__('messages.t_days'), false); ?></span>
                        <?php endif; ?>
                    </p>
                    ...
                    <div class="border-t border-gray-100 flex divide-x divide-gray-100 -mx-6 mt-6 -mb-6">
                        ...
                        <?php if(!$s->is_active): ?>
                            <div class="w-0 flex-1 flex">
                                <button 
                                    wire:click="activate('<?php echo e($s->id, false); ?>')"
                                    wire:loading.class="cursor-not-allowed "
                                    wire:loading.attr="disabled"
                                    class="relative -mr-px w-0 flex-1 inline-flex items-center justify-center py-4 text-sm text-gray-700 font-medium border border-transparent rounded-bl-lg hover:text-gray-500">
                                    
                                    
                                    <div wire:loading wire:target="activate('<?php echo e($s->id, false); ?>')">
                                    ...
                                    <div wire:loading.remove wire:target="activate('<?php echo e($s->id, false); ?>')">
                                    ...
                                    <span class="ltr:ml-3 rtl:mr-3"><?php echo e(__('messages.t_enable'), false); ?></span>
                                </button>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if($s->is_active): ?>
                            <div class="w-0 flex-1 flex">
                                <button 
                                    wire:click="disable('<?php echo e($s->id, false); ?>')"
                                    wire:loading.class="cursor-not-allowed "
                                    wire:loading.attr="disabled"
                                    class="relative -mr-px w-0 flex-1 inline-flex items-center justify-center py-4 text-sm text-gray-700 font-medium border border-transparent rounded-bl-lg hover:text-gray-500">
                                    
                                    
                                    <div wire:loading wire:target="disable('<?php echo e($s->id, false); ?>')">
                                        <svg role="status" class="w-5 h-5 text-gray-700 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z" fill="#E5E7EB"/>
                                            <path d="M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781 93.9676 39.0409Z" fill="currentColor"/>
                                        </svg>
                                    ...
                                    <div wire:loading.remove wire:target="disable('<?php echo e($s->id, false); ?>')">
                                    ...
                                    <span class="ltr:ml-3 rtl:mr-3"><?php echo e(__('messages.t_disable'), false); ?></span>
                                </button>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="ltr:-ml-px rtl:-mr-px w-0 flex-1 flex">
                            <a href="<?php echo e(admin_url('projects/plans/edit/' . $s->id), false); ?>" class="relative w-0 flex-1 inline-flex items-center justify-center py-4 text-sm text-gray-700 font-medium border border-transparent rounded-br-lg hover:text-gray-500">
                                ...
                                <span class="ltr:ml-3 rtl:mr-3"><?php echo e(__('messages.t_edit'), false); ?></span>
                            </a>
                        </div>
    ...
    <div>
        <h3 class="text-lg font-bold text-gray-900">
            <?php echo e(__('messages.t_plans_for_promoting_bids'), false); ?>

        </h3>
        <p class="mt-1 text-sm font-normal text-gray-500">
            <?php echo e(__('messages.t_plans_for_promoting_bids_subtitle'), false); ?>
                ...
                <div class="block bg-white shadow rounded-md">
                    <div class="px-4 py-4 sm:px-6">
                        <div class="flex items-center justify-between">
                            ...
                            <h3 class="inline-flex px-4 py-2 rounded-sm text-xs font-semibold tracking-wide uppercase" style="color: <?php echo e($plan->badge_text_color, false); ?>;background-color: <?php echo e($plan->badge_bg_color, false); ?>;">
                                <?php echo e(__('messages.t_' . $plan->plan_type), false); ?>
                            ...
                            <div class="text-sm text-gray-500">
                                ...
                                <div class="mt-2 flex flex-col text-gray-500 xl:flex-row">
                                    <div class="flex items-start">
                                        ...
                                        <dt class="mt-0.5">
                                            <a class="flex items-center space-x-2 rtl:space-x-reverse group" href="<?php echo e(admin_url('projects/plans/bidding/edit/' . $plan->uid), false); ?>">
                                                ...
                                                <span class="font-medium hover:text-primary-600"><?php echo e(__('messages.t_edit'), false); ?></span>
                                            </a>
                                        </dt>
...
</div><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/projects/plans/plans.blade.php ENDPATH**/ ?>