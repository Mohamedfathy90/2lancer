...
} elseif ($_instance->childHasBeenRendered('LXRvspf')) {
    $componentId = $_instance->getRenderedChildComponentId('LXRvspf');
    $componentTag = $_instance->getRenderedChildComponentTagName('LXRvspf');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LXRvspf');
} else {
    $response = \Livewire\Livewire::mount('main.cards.gig', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('LXRvspf', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/reviews/reviews.blade.php ENDPATH**/ ?>