    ...
    <div class="px-4 md:px-3 py-4 md:py-5 bg-white border !border-b-0 dark:bg-gray-700 rounded-tl-lg rounded-tr-lg">
        <div class="sm:flex items-center justify-between">
            <p class="text-sm font-bold leading-wide text-gray-800">
                <?php echo e(__('messages.t_pages'), false); ?>

            </p>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add_page')): ?>
            <div>
                <a href="<?php echo e(admin_url('pages/create'), false); ?>" class="focus:ring-2 focus:ring-offset-2 focus:ring-primary-600 inline-flex sm:ml-3 mt-4 sm:mt-0 items-start justify-start px-6 py-3 bg-primary-600 hover:bg-primary-700 focus:outline-none rounded-sm">
        ...
        <table class="w-full whitespace-nowrap old-tables">
            <thead class="bg-gray-200">
                <tr tabindex="0"
                    ...
                    <th class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider ltr:text-left ltr:pl-4 rtl:text-right rtl:pr-4"><?php echo e(__('messages.t_slug'), false); ?></th>
            ...
            <tbody class="w-full">
                ...
                <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="focus:outline-none h-20 text-sm leading-none text-gray-800 bg-white dark:bg-zinc-600 hover:bg-gray-100 dark:hover:bg-zinc-700 border-b border-t border-gray-100 dark:border-zinc-700/40" wire:key="pages-<?php echo e($page->id, false); ?>">

                        
                        <td class="ltr:pl-4 rtl:pr-4">
                            <p class="font-medium text-xs"><?php echo e($page->title, false); ?></p>
                        </td>

                        
                        <td class="ltr:pl-4 rtl:pr-4">
                            <p class="font-medium text-xs"><?php echo e($page->slug, false); ?></p>
                        </td>
                                ...
                                <div id="table-options-dropdown-<?php echo e($page->id, false); ?>" class="hidden z-40 origin-top-right absolute right-0 mt-2 w-44 rounded-md shadow-lg bg-white dark:bg-zinc-800 ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 dark:divide-zinc-700 focus:outline-none" role="menu"  aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                    <div class="py-1" role="none">
                                        ...
                                        <a href="<?php echo e(admin_url('pages/edit/' . $page->uid), false); ?>" class="text-gray-800 dark:text-gray-300 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">
                                            ...
                                            <span class="text-xs font-medium"><?php echo e(__('messages.t_edit_page'), false); ?></span>
                                        </a>
                                        <?php endif; ?>

                                        
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_page')): ?>
                                        <button x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_delete_this'), false); ?>') ? $wire.delete('<?php echo e($page->id, false); ?>') : ''" wire:loading.attr="disabled" wire:target="delete('<?php echo e($page->id, false); ?>')" type="button" class="text-gray-800 dark:text-gray-300 dark:hover:text-gray-400 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" >

                                            
                                            <div wire:loading wire:target="delete('<?php echo e($page->id, false); ?>')">
                                            ...
                                            <div wire:loading.remove wire:target="delete('<?php echo e($page->id, false); ?>')">
                                            ...
                                            <span class="text-xs font-medium"><?php echo e(__('messages.t_delete_page'), false); ?></span>
...
<?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/pages/pages.blade.php ENDPATH**/ ?>