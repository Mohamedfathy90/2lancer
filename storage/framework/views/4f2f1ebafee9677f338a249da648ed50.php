...
} elseif ($_instance->childHasBeenRendered('tZwkQ4b')) {
    $componentId = $_instance->getRenderedChildComponentId('tZwkQ4b');
    $componentTag = $_instance->getRenderedChildComponentTagName('tZwkQ4b');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tZwkQ4b');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.overview');
    $html = $response->html();
    $_instance->logRenderedChild('tZwkQ4b', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('m17KaA7')) {
    $componentId = $_instance->getRenderedChildComponentId('m17KaA7');
    $componentTag = $_instance->getRenderedChildComponentTagName('m17KaA7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('m17KaA7');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.pricing');
    $html = $response->html();
    $_instance->logRenderedChild('m17KaA7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('0RXU6je')) {
    $componentId = $_instance->getRenderedChildComponentId('0RXU6je');
    $componentTag = $_instance->getRenderedChildComponentTagName('0RXU6je');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0RXU6je');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.requirements');
    $html = $response->html();
    $_instance->logRenderedChild('0RXU6je', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('I6is0Bf')) {
    $componentId = $_instance->getRenderedChildComponentId('I6is0Bf');
    $componentTag = $_instance->getRenderedChildComponentTagName('I6is0Bf');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('I6is0Bf');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.gallery');
    $html = $response->html();
    $_instance->logRenderedChild('I6is0Bf', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/create/create.blade.php ENDPATH**/ ?>