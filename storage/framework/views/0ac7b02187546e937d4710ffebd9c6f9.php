...
} elseif ($_instance->childHasBeenRendered('b9KCcIO')) {
    $componentId = $_instance->getRenderedChildComponentId('b9KCcIO');
    $componentTag = $_instance->getRenderedChildComponentTagName('b9KCcIO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('b9KCcIO');
} else {
    $response = \Livewire\Livewire::mount('main.cards.gig', ['gig' => $item->gig]);
    $html = $response->html();
    $_instance->logRenderedChild('b9KCcIO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/account/reviews/options/create.blade.php ENDPATH**/ ?>