<div class="flex w-full max-w-sm grow flex-col justify-center p-5">
	...
	<div class="text-center">
		<div class="mt-4">
			...
			<a href="<?php echo e(url('/'), false); ?>" class="block lg:hidden mt-3 text-sm tracking-wider font-semibold text-blue-600 hover:underline">
				...
				<form x-data="window.UcZWcDFfVKBjfgP" x-on:submit.prevent="register" class="grid grid-cols-12 md:gap-x-6 gap-y-6">
					...
					<div class="col-span-12">
						<div class="relative w-full shadow-sm rounded-md">
							...
							<input type="text" x-model="form.fullname" class="<?php echo e($errors->first('fullname') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300', false); ?> border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="<?php echo e(__('messages.t_enter_your_fullname'), false); ?>">
...
$message = $__bag->first($__errorArgs[0]); ?>
							<p class="mt-1.5 text-[13px] tracking-wide text-red-600 font-medium ltr:pl-1 rtl:pr-1">
								<?php echo e($errors->first('fullname'), false); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-span-12">
						<div class="relative w-full shadow-sm rounded-md">
							...
							<input type="text" x-model="form.username" class="<?php echo e($errors->first('username') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300', false); ?> border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="<?php echo e(__('messages.t_enter_username'), false); ?>">
...
$message = $__bag->first($__errorArgs[0]); ?>
							<p class="mt-1.5 text-[13px] tracking-wide text-red-600 font-medium ltr:pl-1 rtl:pr-1">
								<?php echo e($errors->first('username'), false); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-span-12">
						...
						<select wire:model="countryCode" style="width:8.5rem;" class="text-gray-900 text-xs rounded-md font-medium">
							...
							<input style="width:13rem;" type="text" x-model="form.phone" class="<?php echo e($errors->first('phone') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300', false); ?> border text-gray-900 text-sm rounded-md font-medium block ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="<?php echo e(__('messages.t_enter_phone'), false); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-span-12">
                        <div class="flex items-start space-x-2 rtl:space-x-reverse">
                            ...
                            <span class="text-sm text-gray-500 dark:text-zinc-300"><?php echo app('translator')->get('messages.t_by_signup_u_agree_to_terms_privacy'); ?></span>
                        </div>
                    </div>
					...
					<?php if(settings('security')->is_recaptcha): ?>
						<div class="col-span-12" wire:ignore>
							<div class="g-recaptcha" data-sitekey="<?php echo e(config('recaptcha.site_key'), false); ?>" data-theme="<?php echo e(current_theme(), false); ?>"></div>
						</div>
					<?php endif; ?>
			...
			<?php if($social_grid): ?>
				<div class="mt-1 grid grid-cols-5 gap-3">
					...
					<?php if(settings('auth')->is_facebook_login): ?>
						<div>
							<a href="<?php echo e(url('auth/facebook'), false); ?>" class="w-full inline-flex justify-center py-3 rounded-sm bg-zinc-200 hover:bg-[#eeeded] dark:bg-zinc-700 dark:hover:bg-zinc-600 text-sm font-medium">
					...
					<?php if(settings('auth')->is_google_login): ?>
						<div>
							<a href="<?php echo e(url('auth/google'), false); ?>" class="w-full inline-flex justify-center py-3 rounded-sm bg-zinc-200 hover:bg-[#eeeded] dark:bg-zinc-700 dark:hover:bg-zinc-600 text-sm font-medium">
					...
					<?php if(settings('auth')->is_github_login): ?>
						<div>
							<a href="<?php echo e(url('auth/github'), false); ?>" class="w-full inline-flex justify-center py-3 rounded-sm bg-zinc-200 hover:bg-[#eeeded] dark:bg-zinc-700 dark:hover:bg-zinc-600 text-sm font-medium">
					...
					<?php if(settings('auth')->is_twitter_login): ?>
						<div>
							<a href="<?php echo e(url('auth/twitter'), false); ?>" class="w-full inline-flex justify-center py-3 rounded-sm bg-zinc-200 hover:bg-[#eeeded] dark:bg-zinc-700 dark:hover:bg-zinc-600 text-sm font-medium">
					...
					<?php if(settings('auth')->is_linkedin_login): ?>
						<div>
							<a href="<?php echo e(url('auth/linkedin'), false); ?>" class="w-full inline-flex justify-center py-3 rounded-sm bg-zinc-200 hover:bg-[#eeeded] dark:bg-zinc-700 dark:hover:bg-zinc-600 text-sm font-medium">
			...
			<div class="mt-6">
				<ul class="list-disc list-inside text-slate-500 text-[13px] space-y-2 dark:text-gray-300">
					...
					<li>
						<a class="hover:text-slate-600 dark:hover:text-zinc-100 hover:underline" href="<?php echo e(url('auth/login'), false); ?>">
							<?php echo app('translator')->get('messages.t_already_have_account'); ?> <?php echo app('translator')->get('messages.t_login'); ?>
						</a>
					</li>

					
					<li>
						<a class="hover:text-slate-600 dark:hover:text-zinc-100 hover:underline" href="<?php echo e(url('auth/request'), false); ?>">
					...
					<?php if(settings('footer')->privacy && settings('footer')->terms): ?>
						...
						<li>
							<a class="hover:text-slate-600 dark:hover:text-zinc-100 hover:underline" href="<?php echo e(url('page', settings('footer')->privacy->slug), false); ?>"><?php echo e(settings('footer')->privacy->title, false); ?></a>
						</li>

						
						<li>
							<a class="hover:text-slate-600 dark:hover:text-zinc-100 hover:underline" href="<?php echo e(url('page', settings('footer')->terms->slug), false); ?>"><?php echo e(settings('footer')->terms->title, false); ?></a>
						</li>
					<?php endif; ?>
		...
		function UcZWcDFfVKBjfgP() {
			return {
				...
				register() {
					...
					if (_this.recaptcha && document.getElementById('g-recaptcha-response')) {
						...
						if (!recaptcha_token) {
							...
							window.$wireui.notify({
								...
								description: "<?php echo e(__('messages.t_recaptcha_error_message'), false); ?>",
								icon       : 'error'
							});
					...
					// Register
					window.livewire.find('<?php echo e($_instance->id, false); ?>').register({
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/auth/register.blade.php ENDPATH**/ ?>