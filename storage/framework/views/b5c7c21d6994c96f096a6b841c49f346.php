...
<?php if (! $__env->hasRenderedOnce('10d8defa-4077-4ddf-9b25-fdbce3bb73c6')): $__env->markAsRenderedOnce('10d8defa-4077-4ddf-9b25-fdbce3bb73c6');
...
<?php if (! $__env->hasRenderedOnce('ed0e4ef5-832f-47d0-acf4-9a88f45b53cd')): $__env->markAsRenderedOnce('ed0e4ef5-832f-47d0-acf4-9a88f45b53cd');
                    ...
                    document.addEventListener('DOMContentLoaded', () => {
                        $('#<?php echo e($id, false); ?>').fileuploader({
                            ...
                            onSelect: function(item, listEl, parentEl, newInputEl, inputEl) {
                                ...
                                // Upload the new file
                                window.livewire.find('<?php echo e($_instance->id, false); ?>').upload('<?php echo e($model, false); ?>', new_file_updated, (uploadedFilename) => {
                            ...
                            onRemove: function(item) {
                                ...
                                // Remove file
                                window.livewire.find('<?php echo e($_instance->id, false); ?>').removeUpload('<?php echo e($model, false); ?>', data.server, () => {
                                    // Success
                                    window.$wireui.notify({
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/components/forms/attachments-form.blade.php ENDPATH**/ ?>