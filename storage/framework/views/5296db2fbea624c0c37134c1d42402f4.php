            ...
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <div class="mt-5 flex justify-between lg:mt-0 lg:ltr::ml-4 lg:rtl:mr-4">
					...
					<span class="sm:ltr:ml-3 sm:rtl:mr-3">
						<a href="<?php echo e(url('explore/projects'), false); ?>" class="inline-flex items-center rounded-sm border border-transparent bg-primary-600 px-4 py-2 text-[13px] font-semibold text-white shadow-sm hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">
...
</div><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/seller/projects/projects.blade.php ENDPATH**/ ?>