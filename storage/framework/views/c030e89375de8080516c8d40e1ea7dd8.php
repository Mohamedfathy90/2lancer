<div class="w-full bg-white shadow rounded-lg">
    ...
    <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            <div class="mb-14">
                <h2 class="text-sm leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_edit_category'), false); ?></h2>
            </div>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(__('messages.t_category_name'), false).'','placeholder' => ''.e(__('messages.t_enter_category_name'), false).'','model' => 'name','icon' => 'format-title']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(__('messages.t_category_slug'), false).'','placeholder' => ''.e(__('messages.t_enter_category_slug'), false).'','model' => 'slug','icon' => 'link-variant']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal0241d3f51813223308810020791c4a83)): ?>
<?php $component = $__componentOriginal0241d3f51813223308810020791c4a83; ?>
...
<?php endif; ?>
                    ...
                    <?php if($category->icon): ?>
                        <div class="mt-3">
                            <img src="<?php echo e(src( $category->icon ), false); ?>" class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    <?php endif; ?>
                </div>
...
<?php endif; ?>
                    ...
                    <?php if($category->image): ?>
                        <div class="mt-3">
                            <img src="<?php echo e(src( $category->image ), false); ?>" class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    <?php endif; ?>
                </div>
...
</div>    <?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/categories/options/edit.blade.php ENDPATH**/ ?>