            ...
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <div class="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6 rtl:space-x-reverse">
                        ...
                        <?php else: ?>
							...
							<?php echo app('translator')->get('messages.t_not_verified_account'); ?>
                            </div>
                        <?php endif; ?>
                ...
                <div class="mt-5 sm:flex justify-between lg:mt-0 lg:ltr::ml-4 lg:rtl:mr-4">
					...
					<span class="mt-2 sm:mt-0 sm:ltr:ml-3 sm:rtl:mr-3">
						<a href="<?php if(auth()->user()->status == 'verified'): ?> <?php echo e(url('create'), false); ?> <?php else: ?> javascript:void(0) <?php endif; ?>" class="inline-flex items-center rounded-sm border border-transparent bg-primary-600 px-4 py-2 text-[13px] font-semibold text-white shadow-sm hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-zinc-800 dark:focus:ring-zinc-800 whitespace-nowrap">
            ...
            <?php if(auth()->user()->status !== 'verified'): ?>
                <div class="p-4 relative flex bg-amber-50 dark:bg-amber-500 text-amber-500 dark:text-amber-50 text-s font-semibold rounded-lg mb-6">
                    <div class="flex items-center">
                        ...
                        <div class="ltr:ml-2 rtl:mr-2"><?php echo app('translator')->get('messages.t_verify_your_id'); ?> <a style="color:black;text-decoration:underline" href='<?php echo e(route("account.verification"), false); ?>'><?php echo app('translator')->get('messages.t_verify_id'); ?></a></div>
                    </div>
                </div>
            <?php endif; ?>
...
</div><?php /**PATH C:\xampp\htdocs\2lancer\resources\views/livewire/main/seller/home/home.blade.php ENDPATH**/ ?>