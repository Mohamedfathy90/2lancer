...
<?php endif; ?>
                ...
                <?php if(payment_gateway($slug, false, true)?->logo): ?>
                    <div class="mt-3">
                        <img src="<?php echo e(src( payment_gateway($slug, false, true)?->logo ), false); ?>" class="h-32 rounded-lg intense cursor-pointer object-contain">
                    </div>
                <?php endif; ?>
            </div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['rows' => '18','label' => 'Details','placeholder' => 'HTML tags allowed','model' => 'details']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
</div><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/services/payment/gateways/offline.blade.php ENDPATH**/ ?>