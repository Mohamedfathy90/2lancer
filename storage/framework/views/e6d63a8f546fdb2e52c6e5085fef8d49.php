                    ...
                    <div class="py-6 px-4 sm:p-6 lg:pb-8">
                        ...
                        <div class="mb-14 lg:flex lg:items-center lg:justify-between">
                            <div class="flex-1 min-w-0">
                                <h2 class="text-base leading-6 font-bold text-gray-900 dark:text-gray-100"><?php echo e(__('messages.t_delivered_work'), false); ?></h2>
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-300"><?php echo e(__('messages.t_download_received_files_from_seller'), false); ?></p>
                            </div>
                            <?php if(!$item->is_finished && $item->status === 'delivered'): ?>
                                <div class="mt-5 flex lg:mt-0 lg:ltr:ml-4 lg:rtl:mr-4">
                                
                                    
                                    <?php if(!$item->refund): ?>
                                        <span class="block">
                                            <a href="<?php echo e(url('account/refunds/request', $item->uid), false); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-zinc-600 rounded-sm shadow-sm text-xs font-bold tracking-wide text-gray-700 dark:text-gray-200 bg-white dark:bg-zinc-600 hover:bg-gray-50 dark:hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-offset-2">
                                                ...
                                                <?php echo e(__('messages.t_request_refund'), false); ?>
                                    ...
                                    <span class="ltr:ml-3 rtl:mr-3">
                                        <button x-on:click='confirm("<?php echo e(__('messages.t_are_sure_completed_work_buyer'), false); ?>") ? $wire.completed() : "" ' wire:loading.attr="disabled" wire:target="completed" type="button" class="inline-flex items-center px-4 py-2 border border-transparent rounded-sm shadow-sm text-xs font-bold tracking-wide text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                                            ...
                                            <?php echo e(__('messages.t_work_completed'), false); ?> 
                                        </button>
                                    </span>
                        ...
                        <?php if(!$item->is_finished && $item->status === 'delivered'): ?>
                            <div class="flex items-center mb-8 text-blue-500">
                                ...
                                <span class="text-xs font-medium tracking-wide ltr:ml-2 rtl:mr-2"><?php echo e(__('messages.t_order_item_will_mark_done_after_1_week', ['date' => format_date($item->delivered_at, config('carbon-formats.F_j,_Y'))]), false); ?></span>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                                        ...
                                        <div class="bg-gray-50 dark:bg-zinc-600 px-8 py-4 rounded-t-md">
                                            <div class="ltr:-ml-4 rtl:-mr-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                                                <div class="ltr:ml-4 rtl:mr-4 mt-4">
                                                    <h3 class="text-sm leading-6 font-semibold tracking-wide text-gray-600 dark:text-gray-100"><?php echo e(__('messages.t_conversation_with_seller'), false); ?></h3>
                                                    <p class="text-xs font-normal text-gray-400 dark:text-gray-300"><?php echo e(__('messages.t_communicate_with_seller_about_changes'), false); ?></p>
                                                </div>
                                                <div class="ltr:ml-4 rtl:mr-4 mt-4 flex-shrink-0">
                                                    <a href="<?php echo e(url('account/orders'), false); ?>" class="inline-flex items-center py-2 px-3 border border-transparent rounded-full bg-transparent hover:bg-transparent focus:outline-none focus:ring-0">
                                            ...
                                            <div class="w-full">
                                                <ul role="list" class="py-6 px-8">
                                                    ...
                                                    <?php $__currentLoopData = $item->conversation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li wire:key="seller-deliver-order-msg-id-<?php echo e($message->id, false); ?>">
                                                            <div class="relative pb-8">
                                                                ...
                                                                <div class="relative flex items-start space-x-3 rtl:space-x-reverse">
                                                                    <div class="relative">
                                                                        <img class="h-10 w-10 rounded-md bg-gray-400 flex items-center justify-center ring-8 ring-white dark:ring-zinc-700 object-cover lazy" src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src($message->from->avatar), false); ?>" alt="<?php echo e($message->from->username, false); ?>">
                                                                    </div>
                                                                    <div class="min-w-0 flex-1">
                                                                    <div>
                                                                        <div class="text-sm">
                                                                            <a href="<?php echo e(url('profile', $message->from->username), false); ?>" target="_blank" class="font-medium text-gray-900 dark:text-gray-100"><?php echo e($message->from->username, false); ?></a>
                                                                        </div>
                                                                        <p class="mt-1 text-xs text-gray-500"><?php echo e(format_date($message->created_at, 'ago'), false); ?></p>
                                                                    </div>
                                                ...
                                                <div class="mt-auto w-full px-8 py-10 border-t bg-gray-50 dark:border-zinc-700 dark:bg-zinc-600 rounded-br-md">
                                                    <div class="flex items-start space-x-4 rtl:space-x-reverse">
                                                        <div class="flex-shrink-0">
                                                            <img class="inline-block h-10 w-10 rounded-full object-cover lazy" src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src(auth()->user()->avatar), false); ?>" alt="<?php echo e(auth()->user()->username, false); ?>">
                                                        </div>
                                                        <div class="min-w-0 flex-1">
                                                            <div class="relative">
                                                                <div class="border border-gray-300 dark:border-zinc-500 rounded-lg shadow-sm overflow-hidden focus-within:border-primary-600 focus-within:ring-1 focus-within:ring-primary-600">
                                                                    <textarea rows="3" maxlength="750" wire:model.defer="message" class="block w-full py-3 border-0 resize-none focus:ring-0 sm:text-sm dark:bg-transparent dark:text-gray-200 dark:placeholder-gray-300" placeholder="<?php echo e(__('messages.t_type_ur_message_here'), false); ?>"></textarea>
                                                                ...
                                                                <div class="absolute bottom-0 inset-x-0 ltr:pl-3 ltr:pr-2 rtl:pr-3 rtl:pl-2 py-2 flex justify-between">
                                                                    <div></div>
                                                                    <div class="flex-shrink-0">
                                                                        <button wire:click="sendMessage" wire:loading.attr="disabled" wire:target="sendMessage" type="button" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-primary-600 hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-700 dark:ring-offset-primary-600"><?php echo e(__('messages.t_send'), false); ?></button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="col-span-12 xl:col-span-6">
                                ...
                                <?php if($item->delivered_work): ?>
                                    <section class="mb-6">
                                        <div class="rounded-lg bg-white dark:bg-zinc-700 overflow-hidden border border-gray-200 dark:border-zinc-600">
                                            <div class="bg-gray-50 dark:bg-zinc-600 px-8 py-4 rounded-t-md">
                                                <div class="ltr:-ml-4 rtl:-mr-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                                                    <div class="ltr:ml-4 rtl:mr-4 mt-4">
                                                        <h3 class="text-sm leading-6 font-semibold tracking-wide text-gray-600 dark:text-gray-100"><?php echo e(__('messages.t_download_files'), false); ?></h3>
                                                        <p class="text-xs font-normal text-gray-400 dark:text-gray-300"><?php echo e(__('messages.t_always_scan_files_before_open_delivered_work'), false); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="px-8 py-5">
                                                ...
                                                <?php if($item->delivered_work->attached_work): ?>
                                                        ...
                                                        <div class="min-w-0 flex-1 flex items-center space-x-3 rtl:space-x-reverse">
                                                            ...
                                                            <div class="min-w-0 flex-1">
                                                                <p class="text-sm font-medium text-gray-900 dark:text-gray-100 truncate pb-2">
                                                                    <?php echo e($item->delivered_work->attached_work['id'], false); ?>.<?php echo e($item->delivered_work->attached_work['extension'], false); ?>

                                                                </p>
                                                                <p class="text-xs font-[400] text-gray-400 truncate">
                                                                    <?php echo e(human_filesize($item->delivered_work->attached_work['size']), false); ?>
                                                ...
                                                <?php if($item->delivered_work->attached_work): ?>
                                                    <a href="<?php echo e(url('uploads/delivered/' . $item->order->uid . '/' . $item->uid . '/' . $item->delivered_work->id . '/' . $item->delivered_work->attached_work['id']), false); ?>" target="_blank" class="w-full inline-flex items-center justify-center py-3 px-4 border border-transparent rounded-full bg-gray-100 dark:bg-zinc-800 dark:hover:bg-zinc-900 hover:bg-gray-200 focus:outline-none focus:ring-0 mb-6">
                                                ...
                                                <?php if($item->delivered_work->quick_response): ?>
                                                            ...
                                                            <div class="flex flex-col space-y-2 text-sm ltr:ml-2 rtl:mr-2 order-2 items-center">
                                                                <div>
                                                                    <span class="px-4 py-2 rounded-lg italic inline-block bg-gray-100 dark:bg-zinc-600 text-gray-900 dark:text-gray-200 w-full">
                                                                        <?php echo e($item->delivered_work->quick_response, false); ?>

                                                                    </span>
                                                                </div>
                                                            </div>
                                                            <img src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src($item->owner->avatar), false); ?>" alt="<?php echo e($item->owner->username, false); ?>" class="w-10 h-10 rounded-full order-1 object-cover lazy">
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
...
</main><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/account/orders/options/files.blade.php ENDPATH**/ ?>