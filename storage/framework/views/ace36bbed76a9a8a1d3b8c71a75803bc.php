        ...
        <ol class="inline-flex items-center mb-3 space-x-1 md:space-x-3 rtl:space-x-reverse sm:mb-0">
            ...
            <li>
                <div class="flex items-center">
                    <a href="<?php echo e(url('/'), false); ?>" class="ltr:ml-1 rtl:mr-1 text-sm font-medium text-gray-700 hover:text-primary-600 ltr:md:ml-2 rtl:md:mr-2 dark:text-zinc-300 dark:hover:text-white">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <a href="<?php echo e(url('explore/projects'), false); ?>" class="ltr:ml-1 rtl:mr-1 text-sm font-medium text-gray-700 hover:text-primary-600 ltr:md:ml-2 rtl:md:mr-2 dark:text-zinc-300 dark:hover:text-white">
				...
				<section class="w-full">
					<div class="bg-white dark:bg-zinc-800 shadow-sm rounded-lg border dark:border-transparent">
						...
						<div class="border-t border-gray-100 dark:border-zinc-600 px-4 py-5 sm:px-6 pb-8">
							...
							<h2 class="mb-4 font-bold text-zinc-600 dark:text-zinc-300 text-sm">
								<?php echo e(__('messages.t_client_info'), false); ?>    
							</h2> 
							<div class="mb-12 block">
								<div class="flex items-center space-x-4 rtl:space-x-reverse">
									...
									<div class="font-medium text-zinc-800 dark:text-white">
										<div class="text-[13px] mb-1"><?php echo e($this->clientUsername(), false); ?></div>
							...
							<div>
								<h2 class="mb-4 font-bold text-zinc-600 dark:text-zinc-300 text-sm"><?php echo app('translator')->get('messages.t_required_skills'); ?></h2>  
                    ...
                    <div class="border-t border-gray-100 dark:border-zinc-600">
                        <dl>
                            ...
                            <div class="bg-white dark:bg-zinc-700 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500 dark:text-zinc-300"><?php echo app('translator')->get('messages.t_budget'); ?></dt>
                                <dd class="mt-1 text-sm text-zinc-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
                                    <?php echo money($project->budget_min, settings('currency')->code, true); ?> – <?php echo money($project->budget_max, settings('currency')->code, true); ?>
                                </dd>
                            </div>

							
							<div class="bg-gray-50 dark:bg-zinc-600 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500 dark:text-zinc-300"><?php echo app('translator')->get('messages.t_budget_type'); ?></dt>
                                <dd class="mt-1 text-sm text-zinc-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
							...
							<div class="bg-white dark:bg-zinc-700 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
								<dt class="text-sm font-medium text-gray-500 dark:text-zinc-300"><?php echo app('translator')->get('messages.t_bids'); ?></dt>
							...
							<div class="bg-gray-50 dark:bg-zinc-600 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
								<dt class="text-sm font-medium text-gray-500 dark:text-zinc-300"><?php echo app('translator')->get('messages.t_avg_bid'); ?></dt>
								<dd class="mt-1 text-sm text-gray-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
									<?php echo money($avg_bid, settings('currency')->code, true); ?>
								</dd>
							</div>

							
							<div class="bg-white dark:bg-zinc-700 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
								<dt class="text-sm font-medium text-gray-500 dark:text-zinc-300"><?php echo app('translator')->get('messages.t_status'); ?></dt>
							...
							<div class="bg-gray-50 dark:bg-zinc-600 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
								<dt class="text-sm font-medium text-gray-500 dark:text-zinc-300"><?php echo app('translator')->get('messages.t_clicks'); ?></dt>
								<dd class="mt-1 text-sm text-gray-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
									<?php echo e(number_format($project->counter_views), false); ?>
							...
							<div class="bg-white dark:bg-zinc-700 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
								<dt class="text-sm font-medium text-gray-500 dark:text-zinc-300"><?php echo app('translator')->get('messages.t_impressions'); ?></dt>
								<dd class="mt-1 text-sm text-gray-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
									<?php echo e(number_format($project->counter_impressions), false); ?>
							...
							<div class="bg-gray-50 dark:bg-zinc-600 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
								<dt class="text-sm font-medium text-gray-500 dark:text-zinc-300"><?php echo app('translator')->get('messages.t_posted_date'); ?></dt>
								<dd class="mt-1 text-sm text-gray-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
									<?php echo e(format_date($project->created_at, 'ago'), false); ?>
			...
			<div class="grid grid-cols-12 md:gap-x-6 gap-y-6 py-6">
				...
				<div class="col-span-12">
					<ul class="flex items-center justify-center space-x-3 rtl:space-x-reverse">
						...
						<li>
							<a href="https://www.facebook.com/share.php?u=<?php echo e(url()->current(), false); ?>&t=<?php echo e($project->title, false); ?>" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-xl bg-[#3b5998]" data-tooltip-target="share-project-btn-facebook">
						...
						<li>
							<a href="https://twitter.com/intent/tweet?text=<?php echo e($project->title, false); ?>%20-%20<?php echo e(url()->current(), false); ?>%20" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-xl bg-[#1DA1F2]" data-tooltip-target="share-project-btn-twitter">
						...
						<li>
							<a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo e(url()->current(), false); ?>&title=<?php echo e($project->title, false); ?>&summary=<?php echo e($project->title, false); ?>" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-xl bg-[#0A66C2]" data-tooltip-target="share-project-btn-linkedin">
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/project/project.blade.php ENDPATH**/ ?>