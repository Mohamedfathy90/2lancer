...
<?php endif; ?>
    ...
    <main class="px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-2 bg-transparent py-2 ltr:pr-6 rtl:pl-6 ltr:border-l-8 rtl:border-r-8 ltr:pl-4 rtl:pr-4 border-primary-600 rounded">
            ...
            <div>
                <span class="font-extrabold text-base text-gray-800 dark:text-gray-100 pb-1 block tracking-wider"><?php echo e($q, false); ?></span>
                <p class="text-sm text-gray-400"><?php echo e(__('messages.t_search_results_for_q', ['q' => $q]), false); ?></p>
            </div>
                ...
                <div class="lg:col-span-2 xl:col-span-3">
                    <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $gigs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="col-span-12 lg:col-span-6 md:col-span-6 sm:col-span-6 xl:col-span-4" wire:key="gigs-list-<?php echo e($gig->uid, false); ?>">
                                <?php
if (! isset($_instance)) {
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/search/search.blade.php ENDPATH**/ ?>