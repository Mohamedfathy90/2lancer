...
<?php endif; ?>
    ...
    <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            <div class="mb-14">
                <h2 class="text-sm leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_seo_settings'), false); ?></h2>
                <p class="mt-1 text-xs text-gray-500"><?php echo e(__('messages.t_seo_settings_subtitle'), false); ?></p>
            </div>
...
<?php endif; ?>
                    ...
                    <?php if(settings('seo')->ogimage): ?>
                        <div class="mt-3">
                            <img src="<?php echo e(src( settings('seo')->ogimage ), false); ?>" class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    <?php endif; ?>
                </div>
...
<?php endif; ?>
                    ...
                    <div class="flex items-center space-x-4 rtl:space-x-reverse text-xs mt-2">
                        ...
                        <?php if(settings('seo')->is_sitemap): ?>
                        ...
                        <?php if(\File::exists(base_path('sitemap.xml'))): ?>
                            <a href="<?php echo e(url('sitemap.xml'), false); ?>" target="_blank" class="text-gray-400 hover:text-black hover:underline">View sitemap</a>
                        <?php endif; ?>
                    </div>
...
</div>    <?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/settings/seo.blade.php ENDPATH**/ ?>