        ...
        <main class="rounded-lg bg-white dark:bg-zinc-800 shadow border border-gray-200 dark:border-zinc-800 py-8 sm:py-12 px-6 sm:px-10" x-data="{ selected: '<?php echo e($selected, false); ?>' }">
            ...
            <div class="space-y-2 mb-10" x-cloak>
                ...
                <div class="mt-2 space-x-4 rtl:space-x-reverse">
                    ...
                    <?php if(boolval(config('payouts.caixabank.enabled'))): ?>
                        <label class="inline-flex items-center">
                            ...
                            <span class="ltr:ml-2 rtl:mr-2 text-[13px] font-medium dark:text-gray-200">
                                <?php echo e(config('payouts.caixabank.name'), false); ?>
            ...
            <?php if(boolval(config('payouts.attijariwafa.enabled'))): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_details_rib')),'placeholder' => '','model' => 'offline_info','svg_icon' => '<svg class="w-5 h-5 text-gray-400 dark:text-gray-300" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><path d="M894 462c30.9 0 43.8-39.7 18.7-58L530.8 126.2a31.81 31.81 0 0 0-37.6 0L111.3 404c-25.1 18.2-12.2 58 18.8 58H192v374h-72c-4.4 0-8 3.6-8 8v52c0 4.4 3.6 8 8 8h784c4.4 0 8-3.6 8-8v-52c0-4.4-3.6-8-8-8h-72V462h62zM381 836H264V462h117v374zm189 0H453V462h117v374zm190 0H642V462h118v374z"></path></svg>']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal0241d3f51813223308810020791c4a83)): ?>
<?php $component = $__componentOriginal0241d3f51813223308810020791c4a83; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => 'update(\'caixabank\')','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_update')),'block' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal039608dc70b2e4c26356f5d84408f584)): ?>
<?php $component = $__componentOriginal039608dc70b2e4c26356f5d84408f584; ?>
...
</div><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/seller/withdrawals/settings.blade.php ENDPATH**/ ?>