<div class="w-full grid grid-cols-12 md:gap-x-6 gap-y-6">
    ...
    <div class="col-span-12 lg:col-span-8 bg-white shadow rounded-lg">
        <div class="py-10 px-12">
            ...
            <div class="mb-14">
                <h2 class="text-sm leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_smtp_settings'), false); ?></h2>
                <p class="mt-1 text-xs text-gray-500"><?php echo e(__('messages.t_smtp_settings_subtitle'), false); ?></p>
            </div>
...
<?php endif; ?>
    ...
    <div class="col-span-12 lg:col-span-4 bg-white shadow rounded-lg h-fit">
        <div class="py-10 px-7">
            ...
            <div class="mb-14">
                <h2 class="text-sm leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_test_settings'), false); ?></h2>
                <p class="mt-1 text-xs text-gray-500"><?php echo e(__('messages.t_test_settings_smtp_subtitle'), false); ?></p>
            </div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => 'send','text' => ''.e(__('messages.t_send'), false).'','block' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal039608dc70b2e4c26356f5d84408f584)): ?>
<?php $component = $__componentOriginal039608dc70b2e4c26356f5d84408f584; ?>
...
</div>    <?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/settings/smtp.blade.php ENDPATH**/ ?>