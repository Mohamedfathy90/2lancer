                ...
                <div class="mt-5 flex lg:mt-0 lg:ltr::ml-4 lg:rtl:mr-4">
                    ...
                    <span class="block lg:ltr:ml-3 lg:rtl:pr-3">
                        <a href="<?php echo e(admin_url('projects/bids/subscriptions'), false); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-zinc-500 rounded-sm shadow-sm text-[13px] font-medium text-gray-700 dark:text-zinc-200 bg-white dark:bg-zinc-600 hover:bg-gray-50 dark:hover:bg-zinc-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-primary-600 dark:focus:ring-offset-zinc-500 whitespace-nowrap">
                            ...
                            <?php echo e(__('messages.t_subscriptions'), false); ?>
            ...
            <table class="w-full text-left border-spacing-y-[10px] border-separate -mt-2">
                ...
                <thead>
                    <?php $__empty_1 = true; $__currentLoopData = $bids; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bid): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="admin-dashboard-bids-<?php echo e($bid->uid, false); ?>">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-52 rtl:text-right">
                                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                    ...
                                    <a href="<?php echo e(admin_url('users/details/' . $bid->project->client->uid), false); ?>" class="h-10 w-10">
                                        <img class="w-full h-full rounded-md object-cover lazy" src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src($bid->project->client->avatar), false); ?>" alt="<?php echo e($bid->project->client->username, false); ?>">
                                    </a>
                                    ...
                                    <div>
                                        ...
                                        <a href="<?php echo e(url('project/' . $bid->project->pid . '/' . $bid->project->slug), false); ?>" target="_blank" class="font-medium whitespace-nowrap truncate block max-w-[240px] hover:text-primary-600 dark:text-white text-sm" title="<?php echo e($bid->project->title, false); ?>">
                                            <?php echo e($bid->project->title, false); ?>
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <span class="ltr:ml-1 rtl:mr-1 text-xs font-normal text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:hover:text-gray-100" aria-current="page">
                                                                <div class="flex items-center space-x-2 rtl:space-x-reverse text-gray-500 text-xs">
                                                                    ...
                                                                    <div>
                                                                        <?php echo e($bid->project->counter_views, false); ?>
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-48">
                                <a href="<?php echo e(url('profile', $bid->user->username), false); ?>" target="_blank" class="flex items-center">
                                    <div class="w-8 h-8">
                                        <img class="w-full h-full rounded object-cover lazy" src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src($bid->user->avatar), false); ?>" alt="<?php echo e($bid->user->username, false); ?>" />
                                    </div>
                                    <div class="ltr:pl-4 rtl:pr-4">
                                        <p class="font-medium text-sm flex items-center">
                                            <span class="text-zinc-600 hover:text-primary-600"><?php echo e($bid->user->username, false); ?></span>
                                            <?php if($bid->user->status === 'verified'): ?>
                                                <img data-tooltip-target="tooltip-account-verified-<?php echo e($bid->user->id, false); ?>" class="ltr:ml-0.5 rtl:mr-0.5 h-3.5 w-3.5 -mt-0.5" src="<?php echo e(url('public/img/auth/verified-badge.svg'), false); ?>" alt="<?php echo e(__('messages.t_account_verified'), false); ?>">
                                                <div id="tooltip-account-verified-<?php echo e($bid->user->id, false); ?>" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                    <?php echo e(__('messages.t_account_verified'), false); ?>

                                                </div>
                                            <?php endif; ?>
                                        </p>
                                        <p class="text-xs leading-3 text-gray-600 pt-2"><?php echo e($bid->user->email, false); ?></p>
                                    </div>
                                </a>
                            </td>
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                <div class="flex items-center flex-col">
                                    ...
                                    <span class="text-xs text-gray-500">
                                        <?php if($bid->days === 1): ?>
                                            <?php echo e($bid->days, false); ?> <?php echo e(strtolower(__('messages.t_day')), false); ?>

                                        <?php else: ?>
                                            <?php echo e($bid->days, false); ?> <?php echo e(strtolower(__('messages.t_days')), false); ?>
                                    ...
                                    <?php case ('pending_approval'): ?>
                                        <div class="flex items-center flex-col">
                                            <div class="bg-yellow-100 text-yellow-600 px-4 leading-9 h-9 rounded-3xl font-medium text-xs flex items-center space-x-3 rtl:space-x-reverse">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('approve_bid')): ?>
                                                <div class="flex items-center space-x-1 rtl:space-x-reverse">
                                                    ...
                                                    <div>
                                                        ...
                                                        <button type="button" data-tooltip-target="tooltip-actions-approve-<?php echo e($bid->uid, false); ?>" id="modal-approve-bid-button-<?php echo e($bid->uid, false); ?>" class="flex items-center justify-center h-6 w-6 rounded-full border border-transparent bg-white text-yellow-600 hover:bg-transparent hover:border-yellow-600">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-approve-'.e($bid->uid, false).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_approve'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                                    ...
                                                    <div>
                                                        ...
                                                        <button type="button" data-tooltip-target="tooltip-actions-reject-<?php echo e($bid->uid, false); ?>" id="modal-reject-bid-button-<?php echo e($bid->uid, false); ?>" class="flex items-center justify-center h-6 w-6 rounded-full border border-transparent bg-white text-yellow-600 hover:bg-transparent hover:border-yellow-600">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-reject-'.e($bid->uid, false).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_reject'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265)): ?>
<?php $component = $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265; ?>
...
<?php endif; ?>
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                <div class="text-gray-600 dark:text-gray-100 text-sm font-medium whitespace-nowrap">
                                    <?php echo e(format_date($bid->created_at), false); ?>
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                <div class="flex items-center justify-center space-x-4 rtl:space-x-reverse">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_bid')): ?>
                                    <div>
                                        <button type="button" data-tooltip-target="tooltip-actions-preview-<?php echo e($bid->uid, false); ?>" id="modal-preview-bid-button-<?php echo e($bid->uid, false); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-preview-'.e($bid->uid, false).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_preview_bid'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265)): ?>
<?php $component = $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265; ?>
...
<?php endif; ?>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_bid')): ?>
                                    <div>
                                        <button type="button" data-tooltip-target="tooltip-actions-delete-<?php echo e($bid->uid, false); ?>" id="modal-delete-bid-button-<?php echo e($bid->uid, false); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-delete-'.e($bid->uid, false).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_delete_bid'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265)): ?>
<?php $component = $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-preview-bid-container-'.e($bid->uid, false).'','target' => 'modal-preview-bid-button-'.e($bid->uid, false).'','uid' => 'modal_preview_bid_'.e($bid->uid, false).'','placement' => 'center-center','size' => 'max-w-2xl']); ?>
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="mb-8">
                                            ...
                                            <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                                  ...
                                                  <a href="<?php echo e(url('profile', $bid->user->username), false); ?>" class="block">
                                                    <img class="rounded-full h-12 w-12 object-cover object-center lazy" src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src($bid->user->avatar), false); ?>" alt="<?php echo e($bid->user->username, false); ?>">
                                                </a>
                                                    ...
                                                    <div class="flex items-center">
                                                        ...
                                                        <?php if($bid->user->fullname): ?>
                                                            <span class="font-medium text-zinc-900 text-sm hover:text-black ltr:pr-1 rtl:pl-1">
                                                                <?php echo e($bid->user->fullname, false); ?>

                                                            </span>
                                                        <?php endif; ?>
                                    
                                                        
                                                        <a href="<?php echo e(url('profile', $bid->user->username), false); ?>" class="font-medium text-gray-500 text-[13px] hover:text-primary-600 focus:text-primary-600 inline-flex items-center">
                                                            ...
                                                            <span><?php echo e($bid->user->username, false); ?></span>
                                                        </a>
                                                    ...
                                                    <div class="flex items-center space-x-3 rtl:space-x-reverse text-[13px]">
                                                        ...
                                                        <?php if($bid->user->country): ?>
                                                            <p class="flex items-center space-x-1 rtl:space-x-reverse">
                                                                <img class="h-4 ltr:pr-0.5 rtl:pl-0.5 -mt-0.5 lazy" src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(countryFlag($bid->user->country->code), false); ?>" alt="<?php echo e($bid->user->country->name, false); ?>">
                                                                <span><?php echo e($bid->user->country->name, false); ?></span>
                                                            </p>
                                                        ...
                                                        <p class="flex shrink-0 items-center space-x-1 rtl:space-x-reverse">
                                                            <svg aria-hidden="true" class="w-4 h-4 <?php echo e($bid->user->rating() == 0 ? 'text-gray-400' : 'text-amber-500', false); ?> -mt-0.5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                                                            <span>
                                                                <?php echo e($bid->user->rating(), false); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-approve-bid-container-'.e($bid->uid, false).'','target' => 'modal-approve-bid-button-'.e($bid->uid, false).'','uid' => 'modal_approve_bid_'.e($bid->uid, false).'','placement' => 'center-center','size' => 'max-w-md']); ?>

                            
                             <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_approve_bid'), false); ?> <?php $__env->endSlot(); ?>
                             ...
                             <?php $__env->slot('footer', null, []); ?> 
                                <div class="flex justify-between items-center w-full">
                                    ...
                                    <button
                                        type="button" 
                                        wire:click="approve('<?php echo e($bid->id, false); ?>')"
                                        ...
                                        <div wire:loading wire:target="approve('<?php echo e($bid->id, false); ?>')">
                                        ...
                                        <div wire:loading.remove wire:target="approve('<?php echo e($bid->id, false); ?>')">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-reject-bid-container-'.e($bid->uid, false).'','target' => 'modal-reject-bid-button-'.e($bid->uid, false).'','uid' => 'modal_reject_bid_'.e($bid->uid, false).'','placement' => 'center-center','size' => 'max-w-md']); ?>

                            
                             <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_reject_bid'), false); ?> <?php $__env->endSlot(); ?>
...
unset($__errorArgs, $__bag); ?>
                             ...
                             <?php $__env->slot('footer', null, []); ?> 
                                <div class="flex justify-between items-center w-full">
                                    ...
                                    <button
                                        type="button" 
                                        wire:click="reject('<?php echo e($bid->id, false); ?>')"
                                        wire:loading.attr="disabled"
                                        ...
                                        <div wire:loading wire:target="reject('<?php echo e($bid->id, false); ?>')">
                                            <svg role="status" class="inline w-4 h-4 text-gray-700 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z" fill="#E5E7EB"/>
                                                <path d="M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781 93.9676 39.0409Z" fill="currentColor"/>
                                            </svg>
                                        ...
                                        <div wire:loading.remove wire:target="reject('<?php echo e($bid->id, false); ?>')">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-delete-bid-container-'.e($bid->uid, false).'','target' => 'modal-delete-bid-button-'.e($bid->uid, false).'','uid' => 'modal_delete_bid_'.e($bid->uid, false).'','placement' => 'center-center','size' => 'max-w-md']); ?>

                            
                             <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_delete_bid'), false); ?> <?php $__env->endSlot(); ?>
                             ...
                             <?php $__env->slot('footer', null, []); ?> 
                                <div class="flex justify-between items-center w-full">
                                    ...
                                    <button
                                        type="button" 
                                        wire:click="delete('<?php echo e($bid->id, false); ?>')"
                                        wire:loading.attr="disabled"
                                        class="inline-flex justify-center items-center rounded border font-semibold focus:outline-none px-3 py-2 leading-5 text-xs tracking-wide border-transparent bg-red-500 text-white hover:bg-red-600 focus:ring focus:ring-red-500 focus:ring-opacity-25 disabled:bg-gray-200 disabled:hover:bg-gray-200 disabled:text-gray-500 disabled:cursor-not-allowed">
                                        
                                        
                                        <div wire:loading wire:target="delete('<?php echo e($bid->id, false); ?>')">
                                            <svg role="status" class="inline w-4 h-4 text-gray-700 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z" fill="#E5E7EB"/>
                                                <path d="M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781 93.9676 39.0409Z" fill="currentColor"/>
                                            </svg>
                                        ...
                                        <div wire:loading.remove wire:target="delete('<?php echo e($bid->id, false); ?>')">
...
</div><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/projects/bids/bids.blade.php ENDPATH**/ ?>