    ...
    <div class="mb-12 bg-white dark:bg-zinc-800 shadow shadow-gray-100 rounded-md border border-gray-200 dark:border-zinc-700 dark:shadow-none max-w-xl mx-auto">
        ...
        <div class="bg-gray-50 dark:bg-zinc-700 px-8 py-4 rounded-t-md border-b-2 border-gray-100 dark:border-zinc-700">
            <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                ...
                <h3 class="text-sm leading-6 font-semibold text-gray-900 dark:text-gray-100 tracking-wide mb-2"><?php echo e(__('messages.t_contact_us'), false); ?></h3>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-300"><?php echo e(__('messages.t_contact_us_subtitle'), false); ?></p>
                </div>
            </div>
        </div>
...
</div><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/help/contact/contact.blade.php ENDPATH**/ ?>