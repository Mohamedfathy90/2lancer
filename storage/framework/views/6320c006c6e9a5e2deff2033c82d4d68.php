                ...
                <div class="flex items-center md:space-x-5 rtl:space-x-reverse flex-col md:flex-row">
                    ...
                    <div class="flex-shrink-0 mb-5 md:mb-0">
                        <div class="inline-block relative">
                            <img src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src($user->avatar), false); ?>" alt="<?php echo e($user->username, false); ?>" class="inline-block w-16 h-16 rounded-full object-cover lazy">
                        </div>
                    </div>
                    ...
                    <div>
                            ...
                            <div class="flex items-center mb-2 justify-center md:justify-normal">
                                ...
                                <?php if($user->fullname): ?>
                                    <h1 class="text-base font-extrabold text-gray-700 dark:text-zinc-100"><?php echo e($user->fullname, false); ?></h1>
                                <?php else: ?>
                                    <h1 class="text-base font-extrabold text-gray-700 dark:text-zinc-100"><?php echo e($user->username, false); ?></h1>
                                <?php endif; ?>

                                
                                <?php if($user->status === 'verified'): ?>
                                    <div>
                                        <img data-popover-target="popover-profile-verified-<?php echo e($user->uid, false); ?>" data-popover-placement="bottom" class="ltr:ml-0.5 rtl:mr-0.5 h-4 w-4 -mt-0.5" src="<?php echo e(url('public/img/auth/verified-badge.svg'), false); ?>" alt="<?php echo e(__('messages.t_account_verified'), false); ?>">
                            ...
                            <div class="flex items-center md:space-x-3 rtl:space-x-reverse mb-4 md:mb-0 justify-center md:justify-normal space-y-1 md:space-y-0 flex-col md:flex-row">
                                ...
                                <?php if($user->level): ?>
                                    <span class="inline-flex items-center rounded bg-transparent border px-3 py-1 text-xs font-normal tracking-wide" style="color: <?php echo e($user->level->level_color, false); ?>;border-color: <?php echo e($user->level->level_color, false); ?>;">
                                ...
                                <?php if($user->isOnline()): ?>
                                    <span class="inline-flex items-center rounded bg-transparent border border-green-500 px-3 py-1 text-xs font-normal tracking-wide text-green-500 whitespace-nowrap">
                                        ...
                                        <?php echo app('translator')->get('messages.t_online'); ?>
                                    </span>
                                <?php endif; ?>
                                ...
                                <?php if(!$user->isOnline()): ?>
                                    <span class="inline-flex items-center rounded bg-transparent border border-red-500 px-3 py-1 text-xs font-normal tracking-wide text-red-500 whitespace-nowrap">
                                        ...
                                        <?php echo app('translator')->get('messages.t_offline'); ?>
                                    </span>
                                <?php endif; ?>
            ...
            <div class="bg-white shadow-sm shadow-gray-100 border border-slate-100 dark:border-transparent dark:shadow-none rounded-lg dark:bg-zinc-800 divide-y dark:divide-zinc-700 space-y-8 h-fit pb-8">
                    ...
                    <ul class="list-inside text-gray-500 dark:text-zinc-300 text-sm space-y-3">
                        ...
                        <?php if($user->headline): ?>
                            <li>
                                <div class="inline-flex items-start space-x-2 rtl:space-x-reverse">
                                    ...
                                    <span><?php echo e($user->headline, false); ?></span>
                                </div>
                            </li>
                        <?php endif; ?>
                            ...
                            <li>
                                <div class="inline-flex items-center space-x-2 rtl:space-x-reverse">
                                    <div class="w-5 flex justify-center">
                                        <img src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(url('public/img/flags/' . strtolower($user->country->code) . '.svg'), false); ?>" alt="<?php echo e($user->country->name, false); ?>" class="lazy h-3">
                                    </div>
                                    <div>
                                        <?php if($user->city): ?>
                                            <span class="ltr:pr-1 rtl:pl-1"><?php echo e($user->city, false); ?>,</span>
                                        <?php endif; ?>
                        ...
                        <?php if($user->timezone): ?>
                            ...
                            <li>
                                <div class="inline-flex items-start space-x-2 rtl:space-x-reverse">
                                    ...
                                    <span class="lowercase"><?php echo e($now, false); ?> – <?php echo app('translator')->get('messages.t_local_time'); ?></span>
                        ...
                        <?php if($user->account_type === 'seller' && $last_delivery): ?>
                            <li>
                                <div class="inline-flex items-start space-x-2 rtl:space-x-reverse">
                                    ...
                                    <div>
                                        <span><?php echo app('translator')->get('messages.t_last_delivery'); ?></span>
                                        <?php echo e(format_date($last_delivery), false); ?>
                        ...
                        <li>
                            <div class="inline-flex items-start space-x-2 rtl:space-x-reverse">
                                ...
                                <span><?php echo app('translator')->get('messages.t_member_since'); ?> <?php echo e(format_date($user->created_at, config('carbon-formats.F_j,_Y')), false); ?></span>
                            </div>
                        </li>
                ...
                <?php if($seller_loyalty): ?>
                    <div class="px-4 pt-8 flex items-center space-x-3 rtl:space-x-reverse">
                        <div class="flex flex-shrink-0 h-16 items-center justify-center w-16">
                            <img src="<?php echo e(url('public/img/svg/reward-icon.svg'), false); ?>" alt="<?php echo e($user->username, false); ?>">
                        </div>
                        <div class="flex flex-col">
                            <h5 class="flex items-center space-x-1 rtl:space-x-reverse text-[15px] font-medium text-zinc-700 dark:text-zinc-100">
                                <span><?php echo app('translator')->get('messages.t_people_keep_coming_back'); ?></span>
                ...
                <?php if($user->status === 'verified' || $user->email_verified_at): ?>
                    <section class="px-5 pt-8">
                        ...
                        <div class="mb-5">
                            <h1 class="text-base font-extrabold text-zinc-800 tracking-wide dark:text-zinc-100"><?php echo app('translator')->get('messages.t_verifications'); ?></h1>
                        </div>
                        ...
                        <ul class="space-y-2">
                            ...
                            <?php if($user->status === 'verified'): ?>
                                <li class="flex justify-between items-center">
                                    <span class="font-normal text-sm dark:text-zinc-400"><?php echo app('translator')->get('messages.t_id'); ?></span>
                            ...
                            <?php if($user->email_verified_at): ?>
                                <li class="flex justify-between items-center">
                                    <span class="font-normal text-sm dark:text-zinc-400"><?php echo app('translator')->get('messages.t_email_address'); ?></span>
                                    <span class="text-emerald-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase">
                                        <svg class="h-4 w-4" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M4.035 15.479A3.976 3.976 0 0 0 4 16c0 2.378 2.138 4.284 4.521 3.964C9.214 21.198 10.534 22 12 22s2.786-.802 3.479-2.036C17.857 20.284 20 18.378 20 16c0-.173-.012-.347-.035-.521C21.198 14.786 22 13.465 22 12s-.802-2.786-2.035-3.479C19.988 8.347 20 8.173 20 8c0-2.378-2.143-4.288-4.521-3.964C14.786 2.802 13.466 2 12 2s-2.786.802-3.479 2.036C6.138 3.712 4 5.622 4 8c0 .173.012.347.035.521C2.802 9.214 2 10.535 2 12s.802 2.786 2.035 3.479zm1.442-5.403 1.102-.293-.434-1.053A1.932 1.932 0 0 1 6 8c0-1.103.897-2 2-2 .247 0 .499.05.73.145l1.054.434.293-1.102a1.99 1.99 0 0 1 3.846 0l.293 1.102 1.054-.434C15.501 6.05 15.753 6 16 6c1.103 0 2 .897 2 2 0 .247-.05.5-.145.73l-.434 1.053 1.102.293a1.993 1.993 0 0 1 0 3.848l-1.102.293.434 1.053c.095.23.145.483.145.73 0 1.103-.897 2-2 2-.247 0-.499-.05-.73-.145l-1.054-.434-.293 1.102a1.99 1.99 0 0 1-3.846 0l-.293-1.102-1.054.434A1.935 1.935 0 0 1 8 18c-1.103 0-2-.897-2-2 0-.247.05-.5.145-.73l.434-1.053-1.102-.293a1.993 1.993 0 0 1 0-3.848z"></path><path d="m15.742 10.71-1.408-1.42-3.331 3.299-1.296-1.296-1.414 1.414 2.704 2.704z"></path></svg>
                                        <span><?php echo app('translator')->get('messages.t_verified'); ?></span>
                                    </span>
                ...
                <?php if(count($user->languages)): ?>
                    <section class="px-5 pt-8">
                        ...
                        <div class="mb-5">
                            <h1 class="text-base font-extrabold text-zinc-800 tracking-wide dark:text-zinc-100"><?php echo app('translator')->get('messages.t_languages'); ?></h1>
                        </div>
                            ...
                            <?php $__currentLoopData = $user->languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="flex justify-between items-center">
                                    <span class="font-medium text-sm flex items-center space-x-1 rtl:space-x-reverse dark:text-zinc-400">
                                        ...
                                        <span class="capitalize"><?php echo e($lang->name, false); ?></span>
                                    </span>
                ...
                <?php if(settings('security')->is_social_media_accounts && $user_accounts && $user_accounts->exists() && ( $user_accounts->facebook_profile || $user_accounts->twitter_profile || $user_accounts->dribbble_profile || $user_accounts->stackoverflow_profile || $user_accounts->github_profile || $user_accounts->youtube_profile || $user_accounts->vimeo_profile )): ?>
                    <section class="px-5 pt-8">
                        ...
                        <div class="mb-5">
                            <h1 class="text-base font-extrabold text-zinc-800 tracking-wide dark:text-zinc-100"><?php echo app('translator')->get('messages.t_linked_accounts'); ?></h1>
                        </div>
                            ...
                            <?php if($user_accounts->facebook_profile): ?>
                                <li class="flex justify-between items-center">
                                    <span class="font-medium text-sm flex items-center space-x-1 rtl:space-x-reverse dark:text-zinc-400">
                                        ...
                                        <span class="capitalize"><?php echo app('translator')->get('messages.t_facebook'); ?></span>
                                    </span>
                                    <a href="<?php echo e(url('redirect?to=' . safeEncrypt($user_accounts->facebook_profile)), false); ?>" target="_blank" class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                        ...
                                        <span><?php echo app('translator')->get('messages.t_visit_profile'); ?></span>
                                    </a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if($user_accounts->twitter_profile): ?>
                                <li class="flex justify-between items-center">
                                    <span class="font-medium text-sm flex items-center space-x-1 rtl:space-x-reverse dark:text-zinc-400">
                                        ...
                                        <span class="capitalize"><?php echo app('translator')->get('messages.t_twitter'); ?></span>
                                    </span>
                                    <a href="<?php echo e(url('redirect?to=' . safeEncrypt($user_accounts->twitter_profile)), false); ?>" target="_blank" class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                        <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M19 19H5V5h7V3H5a2 2 0 00-2 2v14a2 2 0 002 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"></path></svg>
                                        <span><?php echo app('translator')->get('messages.t_visit_profile'); ?></span>
                                    </a>
                                </li>
                            ...
                            <?php if($user_accounts->dribbble_profile): ?>
                                <li class="flex justify-between items-center">
                                    <span class="font-medium text-sm flex items-center space-x-1 rtl:space-x-reverse dark:text-zinc-400">
                                        ...
                                        <span class="capitalize"><?php echo app('translator')->get('messages.t_dribbble'); ?></span>
                                    </span>
                                    <a href="<?php echo e(url('redirect?to=' . safeEncrypt($user_accounts->dribbble_profile)), false); ?>" target="_blank" class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                        <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M19 19H5V5h7V3H5a2 2 0 00-2 2v14a2 2 0 002 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"></path></svg>
                                        <span><?php echo app('translator')->get('messages.t_visit_profile'); ?></span>
                                    </a>
                                </li>
                            ...
                            <?php if($user_accounts->stackoverflow_profile): ?>
                                <li class="flex justify-between items-center">
                                    <span class="font-medium text-sm flex items-center space-x-1 rtl:space-x-reverse dark:text-zinc-400">
                                        ...
                                        <span class="capitalize"><?php echo app('translator')->get('messages.t_stackoverflow'); ?></span>
                                    </span>
                                    <a href="<?php echo e(url('redirect?to=' . safeEncrypt($user_accounts->stackoverflow_profile)), false); ?>" target="_blank" class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                        <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M19 19H5V5h7V3H5a2 2 0 00-2 2v14a2 2 0 002 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"></path></svg>
                                        <span><?php echo app('translator')->get('messages.t_visit_profile'); ?></span>
                                    </a>
                                </li>
                            ...
                            <?php if($user_accounts->github_profile): ?>
                                <li class="flex justify-between items-center">
                                    <span class="font-medium text-sm flex items-center space-x-1 rtl:space-x-reverse dark:text-zinc-400">
                                        ...
                                        <span class="capitalize"><?php echo app('translator')->get('messages.t_github'); ?></span>
                                    </span>
                                    <a href="<?php echo e(url('redirect?to=' . safeEncrypt($user_accounts->github_profile)), false); ?>" target="_blank" class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                        <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M19 19H5V5h7V3H5a2 2 0 00-2 2v14a2 2 0 002 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"></path></svg>
                                        <span><?php echo app('translator')->get('messages.t_visit_profile'); ?></span>
                                    </a>
                                </li>
                            ...
                            <?php if($user_accounts->youtube_profile): ?>
                                <li class="flex justify-between items-center">
                                    <span class="font-medium text-sm flex items-center space-x-1 rtl:space-x-reverse dark:text-zinc-400">
                                        ...
                                        <span class="capitalize"><?php echo app('translator')->get('messages.t_youtube'); ?></span>
                                    </span>
                                    <a href="<?php echo e(url('redirect?to=' . safeEncrypt($user_accounts->youtube_profile)), false); ?>" target="_blank" class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                        <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M19 19H5V5h7V3H5a2 2 0 00-2 2v14a2 2 0 002 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"></path></svg>
                                        <span><?php echo app('translator')->get('messages.t_visit_profile'); ?></span>
                                    </a>
                                </li>
                            ...
                            <?php if($user_accounts->vimeo_profile): ?>
                                <li class="flex justify-between items-center">
                                    <span class="font-medium text-sm flex items-center space-x-1 rtl:space-x-reverse dark:text-zinc-400">
                                        ...
                                        <span class="capitalize"><?php echo app('translator')->get('messages.t_vimeo'); ?></span>
                                    </span>
                                    <a href="<?php echo e(url('redirect?to=' . safeEncrypt($user_accounts->vimeo_profile)), false); ?>" target="_blank" class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                        <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M19 19H5V5h7V3H5a2 2 0 00-2 2v14a2 2 0 002 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"></path></svg>
                                        <span><?php echo app('translator')->get('messages.t_visit_profile'); ?></span>
                                    </a>
                                </li>
                ...
                <?php if($user->account_type === 'seller' && $user_rating['total'] > 0): ?>
                    <section class="px-5 py-8">
                        ...
                        <div class="mb-5">
                            <h1 class="text-base font-extrabold text-zinc-800 tracking-wide dark:text-zinc-100"><?php echo app('translator')->get('messages.t_reviews'); ?></h1>
                        </div>
                        ...
                        <div class="flex flex-col items-center gap-2">
                            ...
                            <span class="text-sm leading-6 text-slate-400"><?php echo app('translator')->get('messages.t_based_on_number_reviews', ['number' => $user_rating['total']]); ?></span>
                            ...
                            <div class="flex flex-col w-full gap-4 pt-6">
                                ...
                                <span class="flex items-center w-full gap-2">
                                    <label class="mb-0 text-xs text-center w-12 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex"><?php echo app('translator')->get('messages.t_5_stars'); ?></label>
                                    <progress max="100" value="<?php echo e($user_rating['stars_5'] * 100 / $user_rating['total'], false); ?>" class="block h-3 w-full overflow-hidden rounded bg-slate-100 dark:bg-zinc-700 [&::-webkit-progress-bar]:bg-slate-100 dark:[&::-webkit-progress-bar]:bg-zinc-700 [&::-webkit-progress-value]:bg-amber-400 [&::-moz-progress-bar]:bg-amber-400"><?php echo e($user_rating['stars_5'] * 100 / $user_rating['total'], false); ?>%</progress>
                                    <span class="text-xs font-bold w-9 text-slate-700 dark:text-zinc-300"><?php echo e($user_rating['stars_5'], false); ?></span>
                                </span>

                                
                                <span class="flex items-center w-full gap-2">
                                    <label class="mb-0 text-xs text-center w-12 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex"><?php echo app('translator')->get('messages.t_4_stars'); ?></label>
                                    <progress max="100" value="<?php echo e($user_rating['stars_4'] * 100 / $user_rating['total'], false); ?>" class="block h-3 w-full overflow-hidden rounded bg-slate-100 dark:bg-zinc-700 [&::-webkit-progress-bar]:bg-slate-100 dark:[&::-webkit-progress-bar]:bg-zinc-700 [&::-webkit-progress-value]:bg-amber-400 [&::-moz-progress-bar]:bg-amber-400"><?php echo e($user_rating['stars_4'] * 100 / $user_rating['total'], false); ?>%</progress>
                                    <span class="text-xs font-bold w-9 text-slate-700 dark:text-zinc-300"><?php echo e($user_rating['stars_4'], false); ?></span>
                                </span>

                                
                                <span class="flex items-center w-full gap-2">
                                    <label class="mb-0 text-xs text-center w-12 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex"><?php echo app('translator')->get('messages.t_3_stars'); ?></label>
                                    <progress max="100" value="<?php echo e($user_rating['stars_3'] * 100 / $user_rating['total'], false); ?>" class="block h-3 w-full overflow-hidden rounded bg-slate-100 dark:bg-zinc-700 [&::-webkit-progress-bar]:bg-slate-100 dark:[&::-webkit-progress-bar]:bg-zinc-700 [&::-webkit-progress-value]:bg-amber-400 [&::-moz-progress-bar]:bg-amber-400"><?php echo e($user_rating['stars_3'] * 100 / $user_rating['total'], false); ?>%</progress>
                                    <span class="text-xs font-bold w-9 text-slate-700 dark:text-zinc-300"><?php echo e($user_rating['stars_3'], false); ?></span>
                                </span>

                                
                                <span class="flex items-center w-full gap-2">
                                    <label class="mb-0 text-xs text-center w-12 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex"><?php echo app('translator')->get('messages.t_2_stars'); ?></label>
                                    <progress max="100" value="<?php echo e($user_rating['stars_2'] * 100 / $user_rating['total'], false); ?>" class="block h-3 w-full overflow-hidden rounded bg-slate-100 dark:bg-zinc-700 [&::-webkit-progress-bar]:bg-slate-100 dark:[&::-webkit-progress-bar]:bg-zinc-700 [&::-webkit-progress-value]:bg-amber-400 [&::-moz-progress-bar]:bg-amber-400"><?php echo e($user_rating['stars_2'] * 100 / $user_rating['total'], false); ?>%</progress>
                                    <span class="text-xs font-bold w-9 text-slate-700 dark:text-zinc-300"><?php echo e($user_rating['stars_2'], false); ?></span>
                                </span>

                                
                                <span class="flex items-center w-full gap-2">
                                    <label class="mb-0 text-xs text-center w-12 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex"><?php echo app('translator')->get('messages.t_1_star'); ?></label>
                                    <progress max="100" value="<?php echo e($user_rating['stars_1'] * 100 / $user_rating['total'], false); ?>" class="block h-3 w-full overflow-hidden rounded bg-slate-100 dark:bg-zinc-700 [&::-webkit-progress-bar]:bg-slate-100 dark:[&::-webkit-progress-bar]:bg-zinc-700 [&::-webkit-progress-value]:bg-amber-400 [&::-moz-progress-bar]:bg-amber-400"><?php echo e($user_rating['stars_1'] * 100 / $user_rating['total'], false); ?>%</progress>
                                    <span class="text-xs font-bold w-9 text-slate-700 dark:text-zinc-300"><?php echo e($user_rating['stars_1'], false); ?></span>
                                </span>
            ...
            <div class="bg-white shadow-sm shadow-gray-100 border border-slate-100 dark:border-transparent dark:shadow-none rounded-lg dark:bg-zinc-800 col-span-2 py-6 divide-y dark:divide-zinc-700 space-y-8">
                ...
                <?php if($user->description): ?>
                    <section class="px-7">
                        ...
                        <div class="mb-3" id="about-me-element">
                            <h1 class="text-base font-extrabold text-zinc-800 tracking-wide dark:text-zinc-100"><?php echo app('translator')->get('messages.t_about_me'); ?></h1>
                        </div>

                        
                        <div class="text-sm text-gray-500 dark:text-zinc-400 leading-relaxed <?php echo e($enable_more_less ? 'max-h-16 overflow-hidden' : '', false); ?>" id="profile-description-content">
                ...
                <?php if($gigs && $gigs->count()): ?>
                    <section class="px-7 pt-8">
                        ...
                        <div class="mb-5">
                            <h1 class="text-base font-extrabold text-zinc-800 tracking-wide dark:text-zinc-100"><?php echo app('translator')->get('messages.t_recent_gigs'); ?></h1>
                        </div>
                                ...
                                <div class="flex flex-col overflow-hidden [&:not(:first-child)]:pt-4 lg:[&:not(:first-child)]:pt-8" wire:key="profile-gigs-<?php echo e($gig->uid, false); ?>">
                                    <div class="flex flex-col grow md:flex-row md:space-x-6 md:space-y-0 rtl:space-x-reverse space-y-4 w-full">
                                        ...
                                        <div class="grow">
                                            ...
                                            <a href="<?php echo e(url('service', $gig->slug), false); ?>" class="block font-extrabold md:text-base text-black hover:text-gray-500 mb-2 dark:text-zinc-200 dark:hover:text-white">
                                            ...
                                            <div class="text-[13px] text-gray-400 font-normal lowercase mt-2 italic">
                                                ( <?php echo e($gig->counter_reviews, false); ?> )
                                                <?php if($gig->counter_reviews == 0 || $gig->counter_reviews == 1): ?>
                                                    <?php echo app('translator')->get('messages.t_review'); ?>
                                                <?php else: ?>
                                        ...
                                        <div class="flex-none md:w-48 space-y-4 md:ltr:pr-1 md:rtl:pl-1">
                                            ...
                                            <div class="flex flex-col">
                                                <a href="<?php echo e(url('service', $gig->slug), false); ?>" type="button" class="inline-flex justify-center items-center space-x-2 rtl:space-x-reverse border font-semibold focus:outline-none px-3 py-2 leading-6 rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none text-sm dark:bg-zinc-900 dark:border-zinc-800 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:border-zinc-900 dark:hover:text-zinc-300">
                                                    ...
                                                    <span>
                                                        <?php echo app('translator')->get('messages.t_get_started'); ?>
                                                    </span>
                                                </a>
                                            </div>
                ...
                <?php if(count($projects)): ?>
                    <section class="px-7 pt-8">
                        ...
                        <div class="mb-3">
                            <h1 class="text-base font-extrabold text-zinc-800 tracking-wide dark:text-zinc-100"><?php echo app('translator')->get('messages.t_portfolio'); ?></h1>
                        </div>
                                ...
                                <div class="col-span-12 sm:col-span-6 md:col-span-4">
                                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                                        ...
                                        <div class="content pt-3">
                                            <h5 class="mb-1">
                                                <a href="<?php echo e(url('profile/' . $project->user->username . '/portfolio/' . $project->slug), false); ?>" target="_blank" class="hover:text-primary-600 transition-all duration-500 font-medium text-sm block dark:text-zinc-200 dark:hover:text-primary-600">
                ...
                <?php if($user->skills && $user->skills()->count()): ?>
                    <section class="px-7 pt-8">
                        ...
                        <div class="mb-3">
                            <h1 class="text-base font-extrabold text-zinc-800 tracking-wide dark:text-zinc-100"><?php echo app('translator')->get('messages.t_skills'); ?></h1>
                        </div>
                        ...
                        <div class="text-sm text-gray-500 leading-relaxed">
                            <?php $__currentLoopData = $user->skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(url('hire', $skill->slug), false); ?>" class="inline-flex items-center rounded-3xl border border-gray-200 bg-gray-50 px-3.5 py-1.5 text-xs font-normal text-gray-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 tracking-wide ltr:[&:not(:last-child)]:mr-1 rtl:[&:not(:last-child)]:ml-1 mb-2 space-x-1 rtl:space-x-reverse dark:bg-zinc-700 dark:hover:bg-zinc-900 dark:border-zinc-700 dark:hover:border-zinc-900 dark:text-zinc-300">
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/profile/profile.blade.php ENDPATH**/ ?>