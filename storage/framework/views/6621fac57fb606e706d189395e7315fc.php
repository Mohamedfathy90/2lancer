...
} elseif ($_instance->childHasBeenRendered('DrS0bAx')) {
    $componentId = $_instance->getRenderedChildComponentId('DrS0bAx');
    $componentTag = $_instance->getRenderedChildComponentTagName('DrS0bAx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DrS0bAx');
} else {
    $response = \Livewire\Livewire::mount('main.partials.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('DrS0bAx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="http://localhost/2lancer/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
  ...
  <?php /**PATH C:\xampp\htdocs\2lancer\resources\views/livewire/main/seller/layout/app.blade.php ENDPATH**/ ?>