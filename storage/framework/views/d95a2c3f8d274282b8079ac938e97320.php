...
<?php endif; ?>
                ...
                <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
                    ...
                    <div class="py-6 px-4 sm:p-6 lg:pb-8 h-[calc(100%-80px)]">
                        ...
                        <div class="mb-14">
                            <h2 class="text-base leading-6 font-bold text-gray-900 dark:text-gray-100"><?php echo e(__('messages.t_verification_center'), false); ?></h2>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300"><?php echo e(__('messages.t_verification_center_subtitle'), false); ?></p>
                        </div>
                        ...
                        <?php if($verification): ?>
                            ...
                            <div class="sm:col-span-2 mt-6">
                                <dt class="text-xs font-medium text-gray-500"><?php echo e(__('messages.t_verification_documents'), false); ?></dt>
                        ...
                        <?php else: ?>
                            ...
                            <?php if($currentStep === 1): ?>
                                ...
                                <fieldset>
                                    <legend class="text-xs font-medium text-gray-900 dark:text-gray-100 mb-2"><?php echo e(__('messages.t_choose_document_type'), false); ?></legend>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/account/verification/verification.blade.php ENDPATH**/ ?>