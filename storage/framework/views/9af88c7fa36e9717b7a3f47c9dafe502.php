...
<?php endif; ?>
    ...
    <main class="max-w-7xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-2 bg-transparent py-2 ltr:pr-6 rtl:pl-6 ltr:border-l-8 rtl:border-r-8 ltr:pl-4 rtl:pr-4 border-primary-600 rounded">
            ...
            <div>
                <span class="font-extrabold text-base text-gray-800 dark:text-gray-100 pb-1 block tracking-wider"><?php echo e($category->name, false); ?></span>
                <p class="text-sm text-gray-400"><?php echo e($category->description, false); ?></p>
            </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/categories/category.blade.php ENDPATH**/ ?>