<div class="flex flex-col rounded-lg shadow bg-white overflow-hidden">
    ...
    <div class="py-4 px-5 lg:px-6 w-full sm:flex sm:justify-between sm:items-center">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add_project_category')): ?>
                        ...
                        <tr wire:key="projects-categories-<?php echo e($c->uid, false); ?>">
                            ...
                            <td class="p-3 text-center">
                                ...
                                <div class="space-x-4 rtl:space-x-reverse">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_project_category')): ?>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_project_category')): ?>
...
</div><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/projects/categories/categories.blade.php ENDPATH**/ ?>