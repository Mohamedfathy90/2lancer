    ...
    <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
        ...
        <div class="col-span-12 mb-10">
            <div class="md:flex md:items-center md:justify-between ltr:border-l-8 border-primary-600 ltr:pl-4 rtl:border-r-8 rtl:pr-4">
                <div class="flex-1 min-w-0">
                    <h2 class="text-sm font-extrabold text-gray-900 tracking-wider pb-1"><?php echo e(__('messages.t_overview'), false); ?></h2>
                    <p class="text-gray-500 font-medium text-xs"><?php echo e(__('messages.t_update_gig_details_seo_faqs'), false); ?></p>
                </div>
        ...
        <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-7">
            <div class="bg-white rounded-lg shadow-sm border border-gray-10  px-8 py-6">
                ...
                <div class="mb-14">
                    <h2 class="text-sm tracking-wider leading-6 font-black text-gray-900"><?php echo e(__('messages.t_overview'), false); ?></h2>
                    <p class="text-xs text-gray-500"><?php echo e(__('messages.t_edit_gig_basic_details'), false); ?></p>
                </div>
...
<?php endif; ?>
                    ...
                    <div class="col-span-12 lg:col-span-6">
                        <label class="mb-3 block text-xs font-medium <?php echo e($errors->first('category') ? 'text-red-600 dark:text-red-500' : 'text-gray-700', false); ?>"><?php echo e(__('messages.t_choose_parent_category'), false); ?></label>
                        <div class="min-w-0">
                            <ul class="max-h-52 flex-auto space-y-1 overflow-y-auto border-2 rounded <?php echo e($errors->first('category') ? 'border-red-500' : 'border-gray-100', false); ?>">
        
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li wire:click="$set('category', <?php echo e($cat->id, false); ?>)" class="group flex cursor-pointer items-center rounded-0 p-2 hover:bg-gray-50 text-gray-900 <?php echo e($category === $cat->id ? 'bg-gray-50' : '', false); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-span-12 lg:col-span-6">
                        ...
                        <label class="mb-3 block text-xs font-medium <?php echo e($errors->first('subcategory') ? 'text-red-600 dark:text-red-500' : 'text-gray-700', false); ?>"><?php echo e(__('messages.t_choose_subcategory'), false); ?></label>
                        <div class="min-w-0">
                            <ul class="max-h-52 flex-auto space-y-1 overflow-y-auto <?php echo e(count($subcategories) ? 'border-2 rounded' : '', false); ?> <?php echo e($errors->first('subcategory') ? 'border-red-500' : 'border-gray-100', false); ?>">
                                ...
                                <?php $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li wire:click="$set('subcategory', <?php echo e($subcat->id, false); ?>)" class="group flex cursor-pointer items-center rounded-0 p-2 hover:bg-gray-50 text-gray-900 <?php echo e($subcategory === $subcat->id ? 'bg-gray-50' : '', false); ?>">
...
<?php endif; ?>
        ...
        <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-5">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-100 px-8 py-6 mb-6">
                ...
                <div class="mb-14">
                    <h2 class="text-sm tracking-wider leading-6 font-black text-gray-900"><?php echo e(__('messages.t_seo'), false); ?></h2>
                    <p class="text-xs text-gray-500"><?php echo e(__('messages.t_search_engine_gig_preview'), false); ?></p>
                </div>
...
<?php endif; ?>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-100 px-8 py-6 mb-6">
                ...
                <div class="mb-14 flex justify-between items-center">
                    <div>
                        <h2 class="text-sm tracking-wider leading-6 font-black text-gray-900"><?php echo e(__('messages.t_faq'), false); ?></h2>
                        <p class="text-xs text-gray-500"><?php echo e(__('messages.t_create_gig_faq_subtitle'), false); ?></p>
                    </div>
                        ...
                        <div class="col-span-12">
                            <div class="space-y-4">
                                ...
                                <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <details class="px-6 py-4 rounded-lg bg-gray-50 group relative" wire:key="faq-list-id-<?php echo e($key, false); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-span-12">
                    <div>
                        <div class="relative">
                            <textarea placeholder="<?php echo e(__('messages.t_faq_answer_example'), false); ?>" wire:model.defer="answer" rows="8" class="block w-full text-xs rounded border-2 ltr:pr-10 rtl:pl-10 py-3 ltr:pl-3 rtl:pr-3 font-normal resize-none <?php echo e($errors->first('answer') ? 'border-red-500 text-red-600 placeholder-red-400 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 placeholder-gray-400 focus:ring-primary-600 focus:border-primary-600', false); ?>" maxlength="300"></textarea>
                            <div class="absolute inset-y-0 ltr:right-0 rtl:left-0 ltr:pr-3 rtl:pl-3 flex items-center pointer-events-none">
                                <i class="mdi mdi-receipt-text-check <?php echo e($errors->first('answer') ? 'text-red-400' : 'text-gray-400', false); ?>"></i>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/gigs/options/steps/overview.blade.php ENDPATH**/ ?>