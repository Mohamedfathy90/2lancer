    ...
    <div class="mb-16">
        <div class="mx-auto max-w-7xl">
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_publish_settings')): ?>
                                ...
                                <?php if($offer->admin_status === 'pending'): ?>
                                    <div class="flex items-center flex-col">
                                        <div class="bg-yellow-100 text-yellow-600 px-4 leading-9 h-9 rounded-3xl font-medium text-xs flex items-center space-x-3 rtl:space-x-reverse">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('approve_offer')): ?>
                                            <div class="flex items-center space-x-1 rtl:space-x-reverse">
...
<?php endif; ?>
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                <div class="flex justify-center items-center space-x-2 rtl:space-x-reverse">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_offer_details')): ?>
                                    <div>
...
<?php endif; ?>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('release_offer_payment')): ?>
                                        <div>
...
<?php endif; ?>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_offer')): ?>
                                    <div>
                                ...
                                <div class="w-full divide-y divide-gray-300 space-y-8">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <span class="font-bold text-zinc-700 text-sm">
                                            <?php echo money($offer->budget_freelancer_fee, settings('currency')->code, true); ?>    
                                        </span>
                                    </div>
                                    ...
                                    <div class="w-full">
                                        ...
                                        <span class="font-bold text-zinc-700 text-sm">
                                            <?php echo money($offer->budget_buyer_fee, settings('currency')->code, true); ?>    
                                        </span>
                                    </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/offers/offers.blade.php ENDPATH**/ ?>