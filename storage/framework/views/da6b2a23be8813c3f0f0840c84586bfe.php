...
} elseif ($_instance->childHasBeenRendered('bh94LCd')) {
    $componentId = $_instance->getRenderedChildComponentId('bh94LCd');
    $componentTag = $_instance->getRenderedChildComponentTagName('bh94LCd');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bh94LCd');
} else {
    $response = \Livewire\Livewire::mount('main.cards.gig', ['gig' => $review->gig]);
    $html = $response->html();
    $_instance->logRenderedChild('bh94LCd', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/account/reviews/options/edit.blade.php ENDPATH**/ ?>