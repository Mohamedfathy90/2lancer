<div class="rounded-lg shadow bg-white overflow-hidden inline-grid w-full">
    ...
    <div class="py-4 px-5 lg:px-6 w-full sm:flex sm:justify-between sm:items-center">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add_skill')): ?>
                        ...
                        <tr class="hover:bg-gray-50" wire:key="skills-<?php echo e($skill->uid, false); ?>">
                            ...
                            <td class="p-4 text-center">
                                <div class="flex items-center justify-center space-x-4 rtl:space-x-reverse">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_skill')): ?>
                                    <div>
...
<?php endif; ?>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_skill')): ?>
                                    <div>
...
</div><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/projects/skills/skills.blade.php ENDPATH**/ ?>