<div class="w-full">
    ...
    <div class="max-w-xl mx-auto mb-12 text-center block">
        <h1 class="text-xl md:text-3xl font-black text-black dark:text-gray-100 tracking-wide"><?php echo e(__('messages.t_hire_the_best_skill_name_experts', ['skill' => $skill->name]), false); ?></h1>
        <p class="text-xs md:text-sm text-gray-400 dark:text-gray-300 font-medium mt-2"><?php echo e(__('messages.t_hire_the_best_skill_name_experts_subtitle', ['skill' => $skill->name]), false); ?></p>
    </div>
...
</div><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/hire/hire.blade.php ENDPATH**/ ?>