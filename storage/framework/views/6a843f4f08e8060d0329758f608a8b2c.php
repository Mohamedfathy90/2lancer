...
<nav class="w-full <?php echo e($class ? $class : '', false); ?>">
    ...
    <div class="border-b border-gray-100 dark:border-zinc-600">
        ...
        <a href="<?php echo e(url('account/affiliate'), false); ?>"
            class="<?php echo e(Request::is('account/affiliate') ? $link_active_class : $link_basic_class, false); ?> group ltr:border-l-4 rtl:border-r-4 px-5 py-3 flex items-center text-sm font-medium">

            
            <svg class="<?php echo e(Request::is('account/affiliate') ? $icon_active_class : $icon_basic_class, false); ?> flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5" 
            ...
            <span class="truncate text-sm font-semibold"> <?php echo e(__('messages.t_affiliate'), false); ?> </span>
...
<?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/components/main/account/sidebar.blade.php ENDPATH**/ ?>