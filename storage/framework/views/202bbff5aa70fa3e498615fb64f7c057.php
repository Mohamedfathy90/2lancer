                        ...
                        <div class="flex flex-wrap gap-3">
                            <div class="ltr:mr-auto rtl:ml-auto">
                                ...
                                <div class="text-black relative text-2xl font-black leading-5 mt-4">
                                    <?php echo e(number_format($gig->counter_sales), false); ?>
                ...
                <div class="col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-4 xl:col-span-3">
                    <div class="relative block overflow-hidden border border-gray-100 p-5 md:mt-6 bg-white rounded-lg intro-x">
                        <div class="flex flex-wrap gap-3">
                            <div class="ltr:mr-auto rtl:ml-auto">
                                <div class="text-gray-500 flex items-center leading-3 text-sm font-bold">
                                    <?php echo e(__('messages.t_total_clicks'), false); ?>
                ...
                <div class="col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-4 xl:col-span-3">
                    <div class="relative block overflow-hidden border border-gray-100 p-5 md:mt-6 bg-white rounded-lg intro-x">
                        <div class="flex flex-wrap gap-3">
                            <div class="ltr:mr-auto rtl:ml-auto">
                                <div class="text-gray-500 flex items-center leading-3 text-sm font-bold">
                                    <?php echo e(__('messages.t_total_impressions'), false); ?>

                                </div>
                                <div class="text-black relative text-2xl font-black leading-5 mt-4">
                                    <?php echo e(number_format($gig->counter_impressions), false); ?>
                ...
                <div class="col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-4 xl:col-span-3">
                    <div class="relative block overflow-hidden border border-gray-100 p-5 md:mt-6 bg-white rounded-lg intro-x">
                        <div class="flex flex-wrap gap-3">
                            <div class="ltr:mr-auto rtl:ml-auto">
                                <div class="text-gray-500 flex items-center leading-3 text-sm font-bold">
                                    <?php echo e(__('messages.t_total_reviews'), false); ?>
        ...
        <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-5">
            ...
            <div class="bg-white relative block p-8 overflow-hidden border border-gray-100 rounded-lg mb-6">
                ...
                <div class="justify-between sm:flex">
                    <div>
                        <a href="<?php echo e(url('service', $gig->slug), false); ?>" target="_blank" class="text-lg font-bold text-gray-900 hover:text-purple-700">
                            <?php echo e($gig->title, false); ?>

                        </a>
                        <p class="text-[11px] font-[400] text-gray-400 hidden lg:block"><?php echo e(url('service', $gig->slug), false); ?></p>
                    </div>

                    <div class="flex-shrink-0 hidden ltr:ml-3 rtl:mr-3 sm:block">
                        <img
                            class="object-cover w-16 h-16 rounded-lg shadow-sm lazy"
                            src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src($gig->thumbnail), false); ?>"
                            alt="<?php echo e($gig->title, false); ?>"
                        />
                    </div>
                </div>
                ...
                <dl class="flex mt-2 md:mt-6">
                    ...
                    <div class="flex flex-col-reverse">
                        <dt class="text-sm font-medium text-gray-600"><?php echo e(format_date($gig->created_at, 'ago'), false); ?></dt>
                        <dd class="text-[10px] uppercase tracking-widest text-gray-500"><?php echo e(__('messages.t_published'), false); ?></dd>
                    </div>
                    ...
                    <div class="flex flex-col-reverse ltr:ml-3 ltr:sm:ml-6 rtl:mr-3 rtl:sm:mr-6">
                        ...
                        <dd class="text-[10px] uppercase tracking-widest text-gray-500"><?php echo e(__('messages.t_status'), false); ?></dd>
                    </div>
                    ...
                    <div class="bg-slate-50 px-8 py-4 rounded-t-md">
                        <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                            <div class="ltr:ml-4 rtl:mr-4 mt-4">
                                <h3 class="text-sm leading-6 font-semibold tracking-wide text-gray-600 dark:text-gray-200"><?php echo e(__('messages.t_devices'), false); ?></h3>
                                <p class="text-xs font-normal text-gray-400 dark:text-gray-300"><?php echo e(__('messages.t_devices_chart_subtitle'), false); ?></p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-span-7">
                <div class="mb-6 bg-white dark:bg-zinc-800 shadow-sm rounded-md border border-b-0 border-gray-200 dark:border-zinc-700">
                    ...
                    <div class="bg-slate-50 px-8 py-4 rounded-t-md">
                        <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                            <div class="ltr:ml-4 rtl:mr-4 mt-4">
                                <h3 class="text-sm leading-6 font-semibold tracking-wide text-gray-600 dark:text-gray-200"><?php echo e(__('messages.t_visitors_map'), false); ?></h3>
                                <p class="text-xs font-normal text-gray-400 dark:text-gray-300"><?php echo e(__('messages.t_visitors_map_subtitle'), false); ?></p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-7">
            <div class="mb-6 bg-white dark:bg-zinc-800 shadow-sm rounded-md border border-b-0 border-gray-200 dark:border-zinc-700">
                ...
                <div class="bg-slate-50 px-8 py-4 rounded-t-md">
                    <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                        <div class="ltr:ml-4 rtl:mr-4 mt-4">
                            <h3 class="text-sm leading-6 font-semibold tracking-wide text-gray-600 dark:text-gray-200"><?php echo e(__('messages.t_browsers'), false); ?></h3>
                            <p class="text-xs font-normal text-gray-400 dark:text-gray-300"><?php echo e(__('messages.t_browsers_chart_subtitle'), false); ?></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-5">
            <div class="mb-6 bg-white dark:bg-zinc-800 shadow-sm rounded-md border border-b-0 border-gray-200 dark:border-zinc-700">
                ...
                <div class="bg-slate-50 px-8 py-4 rounded-t-md">
                    <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                        <div class="ltr:ml-4 rtl:mr-4 mt-4">
                            <h3 class="text-sm leading-6 font-semibold tracking-wide text-gray-600 dark:text-gray-200"><?php echo e(__('messages.t_os'), false); ?></h3>
                            <p class="text-xs font-normal text-gray-400 dark:text-gray-300"><?php echo e(__('messages.t_os_chart_subtitle'), false); ?></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 xl:col-span-4 mt-3 2xl:mt-8">
            ...
            <div class="mb-6 bg-white shadow-sm rounded-md border border-gray-200">
                <div class="bg-slate-50 px-6 py-4 rounded-md">
                    <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                        <div class="ltr:ml-4 rtl:mr-4 mt-4">
                            <h3 class="text-sm leading-6 font-semibold tracking-wide text-gray-600 dark:text-gray-200"><?php echo e(__('messages.t_recent_orders'), false); ?></h3>
                            <p class="text-xs font-normal text-gray-400 dark:text-gray-300"><?php echo e(__('messages.t_recent_orders_subtitle'), false); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="intro-x">
                    <div class="bg-white rounded-lg px-5 py-3 mb-3 flex items-center zoom-in">
                        <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                            <img class="lazy"  alt="<?php echo e($order->order->buyer->username, false); ?>" src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src($order->order->buyer->avatar), false); ?>">
                        </div>
                        <div class="ltr:ml-4 ltr:mr-auto rtl:mr-4 rtl:ml-auto">
                            <a href="<?php echo e(url('profile', $order->order->buyer->username), false); ?>" class="block font-medium text-[13px] pb-0.5"><?php echo e($order->order->buyer->username, false); ?></a>
                            <div class="text-slate-500 text-xs mt-0.5 text-[11px]"><?php echo e(format_date($order->placed_at, config('carbon-formats.F_j_Y')), false); ?></div>
                        </div>
                        <div class="text-green-500 text-xs font-medium">+ <?php echo money($order->profit_value, settings('currency')->code, true); ?></div>
                    </div>
                </div>
        ...
        <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 xl:col-span-4 mt-3 2xl:mt-8">
            ...
            <div class="mb-6 bg-white shadow-sm rounded-md border border-gray-200">
                <div class="bg-slate-50 px-6 py-4 rounded-md">
                    <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                        <div class="ltr:ml-4 rtl:mr-4 mt-4">
                            <h3 class="text-sm leading-6 font-semibold tracking-wide text-gray-600 dark:text-gray-200"><?php echo e(__('messages.t_referrers'), false); ?></h3>
                            <p class="text-xs font-normal text-gray-400 dark:text-gray-300"><?php echo e(__('messages.t_referrers_subtitle'), false); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $referrers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ref): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="intro-x">
                    <div class="flex space-x-3 bg-white rounded-lg px-5 py-3 mb-3 justify-between items-center zoom-in">
                        <div class="w-10 h-10 flex justify-center items-center rounded-md overflow-hidden" style="background-color: <?php echo e(fake()->hexcolor(), false); ?>">
                            <span class="text-base font-black text-white"><?php echo e(getWebsiteFirstLetter($ref->visit_from), false); ?></span>
                        </div>
                        <div class="flex-1 space-y-1 rtl:!mr-4">
                            <div class="flex items-center justify-between">

                                
                                <?php if(parse_url(url('/'))['host'] == $ref->visit_from): ?>
                                    <div class="block font-medium text-[13px] pb-0.5"><?php echo e($ref->visit_from, false); ?></div>
                                <?php else: ?>
                                    <a href="<?php echo e(url('redirect?to=' . safeEncrypt($ref->referrer)), false); ?>" target="_blank" class="block font-medium text-[13px] pb-0.5"><?php echo e($ref->visit_from, false); ?></a>
                                <?php endif; ?>

                                <div class="text-gray-400 text-xs font-medium"><?php echo e($ref->count, false); ?></div>
                            </div>
                            <div class="text-slate-500 text-xs mt-0.5 text-[11px]"><?php echo e($ref->referrer, false); ?></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 xl:col-span-4 mt-3 2xl:mt-8">
            ...
            <div class="mb-6 bg-white shadow-sm rounded-md border border-gray-200">
                <div class="bg-slate-50 px-6 py-4 rounded-md">
                    <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                        <div class="ltr:ml-4 rtl:mr-4 mt-4">
                            <h3 class="text-sm leading-6 font-semibold tracking-wide text-gray-600 dark:text-gray-200"><?php echo e(__('messages.t_cities'), false); ?></h3>
                            <p class="text-xs font-normal text-gray-400 dark:text-gray-300"><?php echo e(__('messages.t_most_visits_by_cities'), false); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="intro-x">
                    <div class="bg-white rounded-lg px-5 py-3 mb-3 flex items-center zoom-in">
                        <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden ring-gray-100 ring-1">
                            <img class="lazy" alt="<?php echo e($city->country_name, false); ?>" src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(url('public/img/flags', strtolower("$city->country_code.svg")), false); ?>">
                        </div>
                        <div class="ltr:ml-4 ltr:mr-auto rtl:mr-4 rtl:ml-auto">
                            <div class="block font-medium text-[13px] pb-0.5"><?php echo e($city->city, false); ?></div>
                            <div class="text-slate-500 text-xs mt-0.5 text-[11px]"><?php echo e($city->country_name, false); ?></div>
                        </div>
                        <div class="text-gray-500 text-xs font-medium"><?php echo e($city->count, false); ?></div>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="text-center text-sm font-medium text-gray-400 p-5">
            ...
            return {
                ...
                map() {
                    $(function(){
                        ...
                        // Get data
                        const data   = <?php echo json_encode($countries, 15, 512) ?>;
                        ...
                        $('#world-map-visitors').vectorMap({
                            ...
                            onRegionTipShow: function(e, el, code){
                                if (result[code]) {
                                    el.html(el.html()+' (<?php echo e(__("messages.t_visits"), false); ?> '+result[code]+')');
                                }
                            }
                        });
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/gigs/options/analytics.blade.php ENDPATH**/ ?>