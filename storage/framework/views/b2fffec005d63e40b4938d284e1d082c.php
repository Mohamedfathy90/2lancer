            ...
            <div class="relative inline-block align-bottom bg-white rounded-lg px-4 pb-4 ltr:text-left rtl:text-right overflow-hidden shadow transform transition-all sm:align-middle sm:p-6 mb-8 w-full">
                <div>
                    ...
                    <div class="mt-3 sm:mt-5">
                        <h3 class="text-lg text-center leading-6 font-medium text-gray-900" id="modal-title">
                            <?php echo e(__('messages.t_refund_reason'), false); ?>
                ...
                <?php if($refund->status === 'rejected_by_seller' && $refund->request_admin_intervention): ?>
                    <div class="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
                        ...
                        <button x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_approve_this_refund'), false); ?>') ? $wire.accept : ''" wire:loading.attr="disabled" wire:target="accept" type="button" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-primary-600 text-base font-medium text-white hover:bg-primary-700 focus:outline-none sm:col-start-2 sm:text-sm">
            ...
            <div class="bg-white shadow rounded-lg">
                <div class="px-4 py-5 sm:px-6">
                    <h3 class="text-base leading-6 font-medium text-gray-900">
                        <?php echo e(__('messages.t_item_details'), false); ?>
                    ...
                    <dl>
                        ...
                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt class="text-[13px] font-medium text-gray-500">
                                <?php echo e(__('messages.t_item_gig'), false); ?>

                            </dt>
                            <dd class="mt-1 text-[13px] font-medium text-primary-700 hover:text-primary-600 sm:mt-0 sm:col-span-2">
                                <a href="<?php echo e(url('service', $refund->item->gig->slug), false); ?>" target="_blank"><?php echo e($refund->item->gig->title, false); ?></a>
                            </dd>
                        </div>
                        ...
                        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt class="text-[13px] font-medium text-gray-500">
                                <?php echo e(__('messages.t_amount'), false); ?>
                        ...
                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-[13px] font-medium text-primary-700 hover:text-primary-600 sm:mt-0 sm:col-span-2">
                                <a href="<?php echo e(admin_url('users/details/' . $refund->buyer->uid), false); ?>" target="_blank"><?php echo e($refund->buyer->username, false); ?></a>
                            </dd>
                        </div>
                        ...
                        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt class="text-[13px] font-medium text-gray-500">
                                <?php echo e(__('messages.t_item_status'), false); ?>
        ...
        <div class="col-span-12 lg:col-span-6">
            <div class="bg-white shadow-sm rounded-md overflow-hidden border border-gray-100">
                <div class="divide-y divide-gray-200">
                    <div class="px-4 py-5 sm:px-6">
                        <h2 class="text-base leading-6 font-medium text-gray-900"><?php echo e(__('messages.t_conversation'), false); ?></h2>
                    </div>
                    <div class="px-4 py-6 sm:px-6">
                        <ul role="list" class="space-y-8">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <li>
                                    <div class="relative <?php echo e(!$loop->last ? 'pb-8' : '', false); ?>">
                                        <?php if(!$loop->last): ?>
                                        ...
                                        <div class="relative flex items-start space-x-3 rtl:space-x-reverse">
                                            ...
                                            <div class="relative">
                                                <img class="h-10 w-10 rounded-full bg-gray-400 flex items-center justify-center ring-8 ring-white object-cover lazy" src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e($msg->author_type === 'buyer' ? src($msg->buyer->avatar) : src($msg->seller->avatar), false); ?>" alt="<?php echo e($msg->author_type === 'buyer' ? $msg->buyer->username : $msg->seller->username, false); ?>">
                                            </div>
                                            <div class="min-w-0 flex-1">
                                                <div>
                                                    <div class="text-sm">
                                                        <a href="<?php echo e(url('profile', $msg->author_type === 'buyer' ? $msg->buyer->username : $msg->seller->username), false); ?>"
                                                            target="_blank" class="font-medium text-gray-900 hover:text-primary-600"><?php echo e($msg->author_type === 'buyer' ? $msg->buyer->username : $msg->seller->username, false); ?></a>
                                                    </div>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <span class="text-center text-gray-400 block py-12 font-extrabold text-xs tracking-wider"><?php echo e(__('messages.t_no_messages_in_this_refund_conversation'), false); ?></span>
                            <?php endif; ?>
...
<?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/refunds/options/details.blade.php ENDPATH**/ ?>