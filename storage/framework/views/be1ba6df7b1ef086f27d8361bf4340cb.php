...
<button 
    wire:click="<?php echo e($action, false); ?>"
    wire:loading.class="<?php echo e($disabled, false); ?> cursor-not-allowed "
    wire:loading.class.remove="<?php echo e($active, false); ?> cursor-pointer"
    wire:loading.attr="disabled"
    class="<?php echo e($block ? 'w-full' : '', false); ?> text-[13px] font-semibold flex justify-center <?php echo e($active, false); ?> py-4 px-8 rounded tracking-wide focus:outline-none focus:shadow-outline cursor-pointer"
    <?php echo e($attributes, false); ?>

    >

    
    <div wire:loading wire:target="<?php echo e($action, false); ?>">
    ...
    <div wire:loading.remove wire:target="<?php echo e($action, false); ?>">
        <?php echo e(htmlspecialchars_decode($text), false); ?>

    </div>
</button><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/components/forms/button.blade.php ENDPATH**/ ?>