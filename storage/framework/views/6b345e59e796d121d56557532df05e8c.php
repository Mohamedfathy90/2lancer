                ...
                <div class="sm:ml-6">
                    <div class="sm:border-l sm:border-gray-200 sm:pl-6">
                        <h1 class="text-2xl font-extrabold text-gray-900 sm:text-3xl uppercase tracking-widest">
                            <?php echo app('translator')->get('messages.t_unauthorized'); ?>
                        </h1>
                        <p class="mt-1 text-base text-gray-500">
                            <?php echo app('translator')->get('messages.t_sorry_ur_request_could_not_be_processed_try_again'); ?>
                        </p>
                    </div>
...
<?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/errors/401.blade.php ENDPATH**/ ?>