...
<div class="messenger">
    ...
    <div class="messenger-listView <?php echo e(!!$id ? 'conversation-active' : '', false); ?>">
        ...
        <div class="m-header m-header-messaging">
            <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                ...
                <div class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                    ...
                    <a href="#" class="user-name"><?php echo e(config('chatify.name'), false); ?></a>
                </div>
...
<?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/vendor/munafio/chatify/src/views/pages/app.blade.php ENDPATH**/ ?>