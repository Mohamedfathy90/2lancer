                        ...
                        <div class="mt-12 lg:grid lg:grid-cols-12 lg:gap-x-12 lg:items-start xl:gap-x-16">
                                            ...
                                            <div class="ltr:ml-0 rtl:mr-0 flex-1 flex flex-col justify-between ltr:sm:ml-6 rtl:sm:mr-6">
                                                <div class="relative ltr:pr-9 rtl:pl-9 sm:grid sm:grid-cols-2 sm:gap-x-6 ltr:sm:pr-0 rtl:sm:pl-0">
                                                    ...
                                                    <div class="mt-4 sm:mt-0 sm:pr-9 text-center">
                                                        ...
                                                        <p class="mt-1 text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo money($this->itemTotalPrice($item['id']), settings('currency')->code, true); ?></p>
                            ...
                            <dl class="mt-6 space-y-4">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <dd class="text-sm font-medium text-gray-900 dark:text-gray-200"><?php echo money($this->subtotal(), settings('currency')->code, true); ?></dd>
                                </div>
                                ...
                                <?php if(settings('commission')->enable_taxes): ?>
                                    <div class="border-t border-gray-200 dark:border-zinc-600 pt-4 flex items-center justify-between">
                                        ...
                                        <dd class="text-sm font-medium text-gray-900 dark:text-gray-200"><?php echo money($this->taxes(), settings('currency')->code, true); ?></dd>
                                    </div>
                                <?php endif; ?>
                                ...
                                <div class="border-t border-gray-200 dark:border-zinc-600 pt-4 flex items-center justify-between">
                                    ...
                                    <dd class="text-base font-medium text-gray-900 dark:text-white"><?php echo money($this->total() + $this->taxes(), settings('currency')->code, true); ?></dd>
                                </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/cart/cart.blade.php ENDPATH**/ ?>