<div class="relative inline-block">
    <div x-data="{ open: false }">
        ...
        <button x-on:click="open = !open" type="button" class="hidden md:flex items-center text-gray-500 hover:text-primary-600 transition-colors duration-300 py-2 px-4 focus:outline-none focus:ring-0 dark:text-gray-100 dark:hover:text-white">
            ...
            <span class="ltr:ml-1 rtl:mr-1"><?php echo e($default_language_name, false); ?></span>
        </button>
        ...
        <div 
            ...
            <div class="bg-white dark:bg-zinc-800 rounded p-2 space-y-1">
                ...
                <?php $__currentLoopData = supported_languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div <?php if($default_language_code !== $lang->language_code): ?> wire:click="setLocale('<?php echo e($lang->language_code, false); ?>')" <?php endif; ?> class="py-2 px-4 rounded-sm inline-flex items-center cursor-pointer justify-between <?php echo e($default_language_code === $lang->language_code ? 'bg-primary-100/25 text-primary-600' : 'hover:bg-gray-50 dark:hover:bg-zinc-600', false); ?> focus:outline-none w-full">
...
</div><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/partials/languages.blade.php ENDPATH**/ ?>