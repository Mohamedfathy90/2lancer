    ...
    <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            <div class="mb-12 sm:flex items-center justify-between">
                <h2 class="text-sm leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_create_role'), false); ?></h2>
                <div>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(__('messages.t_role_name'), false).'','placeholder' => ''.e(__('messages.t_enter_role_name'), false).'','model' => 'name','icon' => 'format-title']); ?>
...
<?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/admin_management/add-role-component.blade.php ENDPATH**/ ?>