...
<div id="<?php echo e($id, false); ?>" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto fixed top-0 right-0 left-0 z-10 w-full md:inset-0 h-modal md:h-full" wire:ignore.self x-data="window.<?php echo e($uid, false); ?>" x-init="initialize">
        ...
        function <?php echo e(str_replace(['.', '-', "'", '"'], "_", $uid), false); ?>() {
            return {
                ...
                initialize() {
                    ...
                    const targetEl = document.getElementById('<?php echo e($id, false); ?>');
                    ...
                    if (targetEl) {
                        ...
                        const options  = {
                            ...
                            backdropClasses: 'bg-zinc-900 bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-40 ',
                            onHide         : () => {
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/components/forms/modal.blade.php ENDPATH**/ ?>