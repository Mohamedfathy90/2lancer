...
<html lang="<?php echo e(app()->getLocale(), false); ?>" dir="<?php echo e(config()->get('direction'), false); ?>" class="<?php echo \Illuminate\Support\Arr::toCssClasses(['dark' => current_theme() === 'dark']); ?>">
    ...
    <head>
		...
		<?php if(settings('hero')->enable_bg_img): ?>
            ...
            <?php if(config()->get('direction') === 'rtl'): ?> 
                <link rel="preload prefetch" as="image" href='<?php echo e(url("/public/storage/site/hero/hero_medium_rtl.jpg"), false); ?>' type="image/webp" />
                 <?php else: ?> 
            ...
            <?php if(config()->get('direction') === 'rtl'): ?> 
                <link rel="preload prefetch" as="image" href='<?php echo e(url("/public/storage/site/hero/hero_large_rtl.jpg"), false); ?>' type="image/webp" />
                <?php else: ?>                
            ...
            <?php if(settings('hero')->enable_bg_img): ?>
                ...
                <?php if(settings('hero')->background_medium): ?>
                     ...
                     <?php if(config()->get('direction') === 'rtl'): ?> 
                        ...
                        .home-hero-section {
                            background-image: url("public/storage/site/hero/hero_medium_rtl.jpg");
                        }
                        }
                ...
                <?php if(settings('hero')->background_large): ?>
                    ...
                    <?php if(config()->get('direction') === 'rtl'): ?> 
                        ...
                        .home-hero-section {
                            background-image: url("public/storage/site/hero/hero_large_rtl.jpg");
                        }
                        }
...
} elseif ($_instance->childHasBeenRendered('3HLUuvS')) {
    $componentId = $_instance->getRenderedChildComponentId('3HLUuvS');
    $componentTag = $_instance->getRenderedChildComponentTagName('3HLUuvS');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3HLUuvS');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('3HLUuvS', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        ...
        <?php if(request()->is('/')): ?>
            ...
            <div class="home-hero-section">
                <div class="max-w-7xl mx-4 px-4 sm:px-6 lg:px-8 h-full flex items-center">
                                    ...
                                    <?php $__currentLoopData = $popular_tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="flex ltr:mr-3 rtl:ml-3 whitespace-nowrap">
                                            <a href="<?php echo e(url('categories', $tag->slug), false); ?>" class="border-2 border-white rounded-[40px] hover:bg-white hover:text-gray-700 transition-all duration-200 px-3 py-0.5 text-xs">
                                                <?php echo app('translator')->get('messages.t_'.$tag->name); ?>
                                            </a>
                                        </li>
...
} elseif ($_instance->childHasBeenRendered('xpKlBfl')) {
    $componentId = $_instance->getRenderedChildComponentId('xpKlBfl');
    $componentTag = $_instance->getRenderedChildComponentTagName('xpKlBfl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xpKlBfl');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('xpKlBfl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/layout/app.blade.php ENDPATH**/ ?>