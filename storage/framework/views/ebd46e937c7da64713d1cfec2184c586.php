                    ...
                    <ol role="list" class="overflow-hidden">
                        ...
                        <li class="relative pb-8">
                            ...
                            <div class="relative flex items-center group">
                                ...
                                <span class="ml-4 min-w-0 flex flex-col">
                                    <span class="text-xs font-semibold tracking-wide uppercase text-gray-500">Requirements</span>
                                </span>
                            </div>
                        </li>
            ...
            <div class="bg-white shadow rounded-lg mb-6">
                ...
                <div class="w-full mb-8 px-10 pb-8">
                    <ul role="list" class="list-disc space-y-6 text-[13px] font-medium text-gray-500">
                        <li class="leading-6">
                            Riverr is available only on CodeCanyon, if you buy it or download it from another websites it's either a spam or an edited version that may contains malwares. We always recommend you to <a href="<?php echo e($purchase_link, false); ?>" target="_blank" class="text-primary-600">buy riverr</a> from CodeCanyon to get regulary updates and fast support.
                        </li>
                        <li class="leading-6">
                            We typically respond any message within seconds, minutes or maximum hours, you can contact us on <a href="<?php echo e($purchase_link, false); ?>" target="_blank" class="text-primary-600">Codecanyon</a>, email <a href="mailto:MrEdwardHendrix@gmail.com" target="_blank" class="text-primary-600">MrEdwardHendrix@gmail.com</a> or directly using <a href="https://wa.me/<?php echo e($phone, false); ?>" target="_blank" class="text-primary-600">WhatsApp</a> for fast support.
                        </li>
                        <li class="leading-6">
                        ...
                        <li class="leading-6">
                            Please don't forget to give us <span class="text-amber-400">5 stars</span> rating, this will help us move on and provide you with new updates and features.
                        </li>
                        <li class="leading-6">
                    ...
                    <div class="rounded-md bg-red-50 p-4 !mt-8">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-red-800">Please don't leave these fields empty or use wrong data, because your website won't work after the installation is finish.</h3>
                        </div>
                        </div>
                    </div>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Your purchase code','placeholder' => 'Please enter your purchase code','model' => 'purchase_code','icon' => 'key']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Your CodeCanyon username','placeholder' => 'Please enter your CodeCanyon username','model' => 'username','icon' => 'account']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal0241d3f51813223308810020791c4a83)): ?>
<?php $component = $__componentOriginal0241d3f51813223308810020791c4a83; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => 'next','text' => 'Continue']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/installation/start.blade.php ENDPATH**/ ?>