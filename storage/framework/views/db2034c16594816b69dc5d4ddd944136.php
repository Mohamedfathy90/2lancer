			...
			<div x-show="open" class="fixed inset-0 flex z-40 md:hidden" x-ref="dialog" aria-modal="true" style="display: none">
				...
				class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white dark:bg-zinc-800">
					...
					<?php if(current_theme() === 'dark' && settings('general')->logo_dark): ?>
						<a href="<?php echo e(url('/'), false); ?>" class="flex items-center flex-shrink-0 px-5">
					...
					<div class="mt-8 flex-grow flex flex-col">
						<nav class="flex-1 ltr:pl-2 rtl:pr-5 pb-4 space-y-1.5">
							...
							<a href="<?php echo e(url('seller/gigs'), false); ?>" class="group flex items-center ltr:pl-3 ltr:pr-2 rtl:pr-3 rtl:pl-2 py-2 text-sm font-semibold tracking-wide ltr:rounded-l-full rtl:rounded-r-full <?php echo e(\Illuminate\Support\Str::of(request()->path())->startsWith('seller/gigs') ? 'bg-slate-100 hover:bg-slate-200 text-slate-500 hover:text-slate-700 dark:bg-zinc-700 dark:text-zinc-200 dark:hover:text-zinc-100' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700 dark:hover:bg-zinc-700 dark:text-zinc-200 dark:hover:text-zinc-100', false); ?>">
								...
								<span><?php echo app('translator')->get('messages.t_gigs'); ?></span>
							</a>

							
							<?php if(settings('projects')->is_enabled): ?>
								<a href="<?php echo e(url('seller/projects'), false); ?>" class="group flex items-center ltr:pl-3 ltr:pr-2 rtl:pr-3 rtl:pl-2 py-2 text-sm font-semibold tracking-wide ltr:rounded-l-full rtl:rounded-r-full <?php echo e(\Illuminate\Support\Str::of(request()->path())->startsWith('seller/projects') ? 'bg-slate-100 hover:bg-slate-200 text-slate-500 hover:text-slate-700 dark:bg-zinc-700 dark:text-zinc-200 dark:hover:text-zinc-100' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700 dark:hover:bg-zinc-700 dark:text-zinc-200 dark:hover:text-zinc-100', false); ?>">
									...
									<span><?php echo app('translator')->get('messages.t_projects'); ?></span>
								</a>
							<?php endif; ?>

							
							<?php if(settings('publish')->enable_custom_offers): ?>
								<a href="<?php echo e(url('seller/offers'), false); ?>" class="group flex items-center ltr:pl-3 ltr:pr-2 rtl:pr-3 rtl:pl-2 py-2 text-sm font-semibold tracking-wide ltr:rounded-l-full rtl:rounded-r-full <?php echo e(\Illuminate\Support\Str::of(request()->path())->startsWith('seller/offers') ? 'bg-slate-100 hover:bg-slate-200 text-slate-500 hover:text-slate-700 dark:bg-zinc-700 dark:text-zinc-200 dark:hover:text-zinc-100' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700 dark:hover:bg-zinc-700 dark:text-zinc-200 dark:hover:text-zinc-100', false); ?>">
									...
									<span><?php echo app('translator')->get('messages.t_offers'); ?></span>
								</a>
							<?php endif; ?>

							
							<a href="<?php echo e(url('seller/reviews'), false); ?>" class="group flex items-center ltr:pl-3 ltr:pr-2 rtl:pr-3 rtl:pl-2 py-2 text-sm font-semibold tracking-wide ltr:rounded-l-full rtl:rounded-r-full <?php echo e(\Illuminate\Support\Str::of(request()->path())->startsWith('seller/reviews') ? 'bg-slate-100 hover:bg-slate-200 text-slate-500 hover:text-slate-700 dark:bg-zinc-700 dark:text-zinc-200 dark:hover:text-zinc-100' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700 dark:hover:bg-zinc-700 dark:text-zinc-200 dark:hover:text-zinc-100', false); ?>">
								...
								<span><?php echo app('translator')->get('messages.t_reviews'); ?></span>
							</a>

							
							<a href="<?php echo e(url('seller/refunds'), false); ?>" class="group flex items-center ltr:pl-3 ltr:pr-2 rtl:pr-3 rtl:pl-2 py-2 text-sm font-semibold tracking-wide ltr:rounded-l-full rtl:rounded-r-full <?php echo e(\Illuminate\Support\Str::of(request()->path())->startsWith('seller/refunds') ? 'bg-slate-100 hover:bg-slate-200 text-slate-500 hover:text-slate-700 dark:bg-zinc-700 dark:text-zinc-200 dark:hover:text-zinc-100' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700 dark:hover:bg-zinc-700 dark:text-zinc-200 dark:hover:text-zinc-100', false); ?>">
								...
								<span><?php echo app('translator')->get('messages.t_refunds'); ?></span>
							</a>

							
							<a href="<?php echo e(url('seller/portfolio'), false); ?>" class="group flex items-center ltr:pl-3 ltr:pr-2 rtl:pr-3 rtl:pl-2 py-2 text-sm font-semibold tracking-wide ltr:rounded-l-full rtl:rounded-r-full <?php echo e(\Illuminate\Support\Str::of(request()->path())->startsWith('seller/portfolio') ? 'bg-slate-100 hover:bg-slate-200 text-slate-500 hover:text-slate-700 dark:bg-zinc-700 dark:text-zinc-200 dark:hover:text-zinc-100' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700 dark:hover:bg-zinc-700 dark:text-zinc-200 dark:hover:text-zinc-100', false); ?>">
								...
								<span><?php echo app('translator')->get('messages.t_portfolio'); ?></span>
							</a>

							
							<a href="<?php echo e(url('seller/withdrawals'), false); ?>" class="group flex items-center ltr:pl-3 ltr:pr-2 rtl:pr-3 rtl:pl-2 py-2 text-sm font-semibold tracking-wide ltr:rounded-l-full rtl:rounded-r-full <?php echo e(\Illuminate\Support\Str::of(request()->path())->startsWith('seller/withdrawals') ? 'bg-slate-100 hover:bg-slate-200 text-slate-500 hover:text-slate-700 dark:bg-zinc-700 dark:text-zinc-200 dark:hover:text-zinc-100' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700 dark:hover:bg-zinc-700 dark:text-zinc-200 dark:hover:text-zinc-100', false); ?>">
								...
								<span><?php echo app('translator')->get('messages.t_payouts'); ?></span>
							</a>
...
} elseif ($_instance->childHasBeenRendered('vCztKjy')) {
    $componentId = $_instance->getRenderedChildComponentId('vCztKjy');
    $componentTag = $_instance->getRenderedChildComponentTagName('vCztKjy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vCztKjy');
} else {
    $response = \Livewire\Livewire::mount('main.partials.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('vCztKjy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="https://2lancer.ma/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
  ...
  <?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/seller/layout/app.blade.php ENDPATH**/ ?>