        ...
        <div class="flex flex-col justify-start ltr:ml-1.5 rtl:mr-1.5">
            ...
            <?php if($message): ?>
                ...
                $lang = 'en';
                    ...
                    $message = mb_convert_encoding($message,mb_detect_encoding($message),'UTF-8');
                }
                preg_match_all('/.|\n/u', $message, $matches);
                $chars = $matches[0];
                $arabic_count = 0;
                ...
                <div class="msg-card-content" style="<?php echo e($lang=='ar' ? 'text-align:right;' : 'text-align:left;', false); ?>" title="<?php echo e($fullTime, false); ?>">
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\2lancer\resources\views/vendor/Chatify/layouts/messageCard.blade.php ENDPATH**/ ?>