...
unset($__errorArgs, $__bag); ?>
					...
					<div class="col-span-12 flex items-center">
						<div class="relative flex items-start">
							...
							<div class="ltr:ml-3 rtl:mr-3 text-[13px]">
								<label for="remember_me" class="font-normal text-zinc-600 dark:text-gray-400 cursor-pointer"><?php echo e(__('messages.t_remember_me'), false); ?></label>
							</div>
						</div>
					</div>
			...
			<div class="mt-6">
				<ul class="list-disc list-inside text-slate-500 text-[13px] space-y-2 dark:text-gray-300">
					...
					<li>
						<a class="hover:text-slate-600 dark:hover:text-zinc-100 hover:underline" href="<?php echo e(url('auth/register'), false); ?>">
					...
					<li>
						<a class="hover:text-slate-600 dark:hover:text-zinc-100 hover:underline" href="<?php echo e(url('auth/password/reset'), false); ?>">
		...
		function zyKtAkZuKbBmbfC() {
			return {
				...
				login() {
					...
					// Login
					window.livewire.find('<?php echo e($_instance->id, false); ?>').login({
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/auth/login.blade.php ENDPATH**/ ?>