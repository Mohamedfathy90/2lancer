                ...
                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white dark:bg-zinc-600 hover:bg-gray-100 dark:hover:bg-zinc-700 border-b border-t border-gray-100 dark:border-zinc-700/40" wire:key="orders-<?php echo e($order->id, false); ?>">
                        ...
                        <td class="text-center">
                            <span class="text-xs font-bold "><?php echo money($order->total_value, settings('currency')->code, true); ?></span>
                        </td>

                        
                        <td class="text-center">
                            <span class="text-xs font-bold "><?php echo money($order->subtotal_value, settings('currency')->code, true); ?></span>
                        </td>

                        
                        <td class="text-center">
                            <span class="text-xs font-bold "><?php echo money($order->taxes_value, settings('currency')->code, true); ?></span>
                        </td>
...
<?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/orders/orders.blade.php ENDPATH**/ ?>