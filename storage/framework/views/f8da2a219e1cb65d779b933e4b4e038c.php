                                ...
                                <li>
                                    <?php if($page->is_link && $page->link): ?>
                                        <a href="<?php echo e($page->link, false); ?>" target="_blank" class="block font-normal text-gray-400 hover:text-gray-600 hover:underline dark:text-gray-100 dark:hover:text-gray-50 text-sm mb-2">
                                             <?php echo app('translator')->get('messages.t_'.$page->title); ?> 
                                        </a>
                                    <?php else: ?>
                ...
                <?php if(settings('footer')->is_language_switcher || settings('appearance')->is_dark_mode): ?>
                    <div class="mt-10 grid grid-cols-1 gap-y-4">
                        ...
                        <?php if(settings('footer')->is_language_switcher): ?>
                            ...
                            <button data-dropdown-toggle="change-footer-language-dropdown" data-dropdown-placement="<?php echo e(config()->get('direction') === 'ltr' ? 'top-end' : 'top-start', false); ?>"  type="button" class="inline-flex items-center px-2.5 py-2 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-600 dark:bg-zinc-600 dark:text-gray-300 dark:border-zinc-600 dark:focus:ring-offset-zinc-600 dark:hover:bg-zinc-800 max-w-fit">
                                <img src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(url('public/img/flags/rounded/'. strtolower($default_country_code) .'.svg'), false); ?>" alt="" class="lazy w-4 h-4 ltr:mr-3 rtl:ml-3">
                                <span class="text-xs font-semibold text-gray-500 dark:text-gray-300 whitespace-nowrap"><?php echo e($default_language_name, false); ?></span>
            ...
            <div>
                <div class="flex items-center space-x-2 rtl:space-x-reverse">
                    ...
                    <?php if(settings('footer')->social_facebook): ?>
                        <a href="<?php echo e(settings('footer')->social_facebook, false); ?>" target="_blank" data-tooltip-target="tooltip-follow-us-facebook" class="w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-zinc-600 rounded-md group rtl:ml-2">
                    ...
                    <?php if(settings('footer')->social_twitter): ?>
                        <a href="<?php echo e(settings('footer')->social_twitter, false); ?>" target="_blank" data-tooltip-target="tooltip-follow-us-twitter" class="w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-zinc-600 rounded-md group">
                    ...
                    <?php if(settings('footer')->social_instagram): ?>
                        <a href="<?php echo e(settings('footer')->social_instagram, false); ?>" target="_blank" data-tooltip-target="tooltip-follow-us-instagram" class="w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-zinc-600 rounded-md group">
                    ...
                    <?php if(settings('footer')->social_pinterest): ?>
                        <a href="<?php echo e(settings('footer')->social_pinterest, false); ?>" target="_blank" data-tooltip-target="tooltip-follow-us-pinterest" class="w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-zinc-600 rounded-md group">
                    ...
                    <?php if(settings('footer')->social_linkedin): ?>
                        <a href="<?php echo e(settings('footer')->social_linkedin, false); ?>" target="_blank" data-tooltip-target="tooltip-follow-us-linkedin" class="w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-zinc-600 rounded-md group">
                    ...
                    <?php if(settings('footer')->social_github): ?>
                        <a href="<?php echo e(settings('footer')->social_github, false); ?>" target="_blank" data-tooltip-target="tooltip-follow-us-github" class="w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-zinc-600 rounded-md group">
                    ...
                    <?php if(settings('footer')->social_youtube): ?>
                        <a href="<?php echo e(settings('footer')->social_youtube, false); ?>" target="_blank" data-tooltip-target="tooltip-follow-us-youtube" class="w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-zinc-600 rounded-md group">
...
<!--
            ...
            <div class="flex space-x-4 justify-center rtl:space-x-reverse">
                ...
                <?php if(settings('footer')->terms): ?>
                    <a href="<?php echo e(url('page', settings('footer')->terms->slug), false); ?>" class="text-xs font-medium uppercase text-gray-600 dark:text-gray-400 dark:hover:text-gray-100 hover:underline"><?php echo e(__('messages.t_terms_of_service'), false); ?></a>
                <?php endif; ?>

                
                <?php if(settings('blog')->enable_blog): ?>
                    <a href="<?php echo e(url('blog'), false); ?>" class="text-xs font-medium uppercase text-gray-600 dark:text-gray-400 dark:hover:text-gray-100 hover:underline"><?php echo e(__('messages.t_blog'), false); ?></a>
                <?php endif; ?>
...
</footer><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/includes/footer.blade.php ENDPATH**/ ?>