<header class="z-10 py-4 bg-white shadow-sm dark:bg-gray-800 h-16 fixed w-full">
    <div class="flex items-center justify-between h-full px-6 text-purple-600 dark:text-purple-300">
        ...
        <div class="h-full flex items-center">
            ...
            <a href="<?php echo e(admin_url(), false); ?>" class="block h-full">
                <img src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src(settings('general')->logo), false); ?>" alt="<?php echo e(settings('general')->title, false); ?>" class="lazy h-full hidden md:block">
            </a>
        </div>
            ...
            <li class="flex">
                ...
                <div id="admin-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 !mt-2">
                    <ul class="py-1 text-xs font-bold tracking-wide text-gray-700 dark:text-gray-200">
                        ...
                        <li>
                            <a href="<?php echo e(url('https://wa.me/'. config('global.whatsapp') .'/?text=Hello'), false); ?>" target="_blank" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                <?php echo e(__('messages.t_fast_support'), false); ?>
                        ...
                        <li>
                            <a href="<?php echo e(admin_url('profile'), false); ?>" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                <?php echo e(__('messages.t_edit_profile'), false); ?>
                        ...
                        <li>
                            <a href="<?php echo e(url('/'), false); ?>" target="_blank" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                <?php echo e(__('messages.t_go_homepage'), false); ?>
                    ...
                    <div class="py-1 text-xs font-bold tracking-wide">
                        ...
                        <a href="<?php echo e(admin_url('logout'), false); ?>" class="block py-2 px-4 text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                            <?php echo e(__('messages.t_logout'), false); ?>
...
<?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/includes/header.blade.php ENDPATH**/ ?>