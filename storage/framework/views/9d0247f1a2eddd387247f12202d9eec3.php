			...
			<div class="h-80 w-full absolute bottom-0 xl:inset-0 xl:h-full">
				<div class="h-full w-full xl:grid xl:grid-cols-2">
					<div class="h-full xl:relative xl:col-start-2">
						<img class="h-full w-full object-cover opacity-25 xl:absolute xl:inset-0 ltr:rounded-r-lg rtl:rounded-l-lg lazy" src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(url('public/img/start_selling/1.jpg'), false); ?>" alt="<?php echo e(__('messages.t_u_bring_the_skill_make_earn_easy'), false); ?>">
			...
			<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-cols-2 xl:grid-flow-col-dense xl:gap-x-8">
				  <div class="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
					...
					<div class="mt-12 grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2">
						...
						<p>
							<span class="block text-xl font-bold text-white uppercase"><?php echo e(__('messages.t_4_sec'), false); ?></span>
							<span class="mt-1 block text-base text-gray-300"><?php echo e(__('messages.t_a_gig_is_bought_every'), false); ?></span>
						</p>
				
						
						<p>
							<span class="block text-xl font-bold text-white uppercase"><?php echo e(__('messages.t_50_m_plus'), false); ?></span>
							<span class="mt-1 block text-base text-gray-300"><?php echo e(__('messages.t_transactions'), false); ?></span>
						</p>
				
						
						<p>
							<span class="block text-xl font-bold text-white uppercase">
								<?php echo money(80, settings('currency')->code, true); ?> - <?php echo money(50000, settings('currency')->code, true); ?>
							</span>
							<span class="mt-1 block text-base text-gray-300"><?php echo e(__('messages.t_price_range'), false); ?></span>
						</p>
				
						
						<p>
							<span class="block text-xl font-bold text-white uppercase"><?php echo e(__('messages.t_5_million'), false); ?></span>
							<span class="mt-1 block text-base text-gray-300"><?php echo e(__('messages.t_active_monthly_visits'), false); ?></span>
						</p>
			...
			<?php $__currentLoopData = $sellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div>
					<div class="group relative p-4 mb-5 min-h-[190px flex]">
						...
						<img src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(url('public/img/start_selling/' . $seller['avatar']), false); ?>" alt="<?php echo e($seller['name'], false); ?>" class="relative rounded-lg shadow object-cover lazy">
					</div>
				  ...
				  <div class="mt-12 max-w-sm mx-auto grid grid-cols-1 gap-y-10 gap-x-8 sm:max-w-none lg:grid-cols-3">
					...
					<div class="text-center sm:flex sm:text-left lg:block lg:text-center">
						...
						<div class="mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
							<h3 class="text-base font-extrabold text-white"><?php echo e(__('messages.t_create_a_gig'), false); ?></h3>
							<p class="mt-2 text-sm text-primary-100"><?php echo e(__('messages.t_start_selling_t_create_a_gig_subtitle'), false); ?></p>
						</div>
					</div>
					...
					<div class="text-center sm:flex sm:text-left lg:block lg:text-center">
						...
						<div class="mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
							<h3 class="text-base font-extrabold text-white"><?php echo e(__('messages.t_deliver_great_work'), false); ?></h3>
							<p class="mt-2 text-sm text-primary-100"><?php echo e(__('messages.t_deliver_great_work_subtitle'), false); ?></p>
						</div>
					</div>
					...
					<div class="text-center sm:flex sm:text-left lg:block lg:text-center">
						...
						<div class="mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
							<h3 class="text-base font-extrabold text-white"><?php echo e(__('messages.t_get_paid'), false); ?></h3>
							<p class="mt-2 text-sm text-primary-100"><?php echo e(__('messages.t_get_paid_subtitle'), false); ?></p>
						</div>
					</div>
						...
						<blockquote>
							...
							<footer class="flex items-center space-x-4 rtl:space-x-reverse">
								<div class="flex-none rounded-full overflow-hidden w-12 h-12 transform transition ease-out duration-150 dark:hover:bg-zinc-700 hover:shadow-md hover:scale-125 active:shadow-sm active:scale-110">
									<img src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(url('public/img/start_selling/9.jpg'), false); ?>" alt="<?php echo e(__('messages.t_fake_name_alex_saunders'), false); ?>" class="object-cover w-12 h-12 lazy">
								</div>
								<div>
									<div class="font-semibold text-primary-600 hover:text-primary-400">
										<?php echo e(__('messages.t_fake_name_alex_saunders'), false); ?>

									</div>
									<p class="text-gray-500 font-medium text-sm">
										<?php echo e(__('messages.t_entrepreneur'), false); ?>
			...
			<div class="border rounded-md bg-white dark:bg-zinc-800 dark:border-zinc-700 shadow-sm relative">
				...
				<div class="px-4 pt-14 pb-6 sm:px-6 sm:pb-6 relative">
					<blockquote>
						...
						<footer class="flex items-center space-x-4 rtl:space-x-reverse">
							<div class="flex-none rounded-full overflow-hidden w-12 h-12 transform transition ease-out duration-150 dark:hover:bg-zinc-700 hover:shadow-md hover:scale-125 active:shadow-sm active:scale-110">
								<img src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(url('public/img/start_selling/7.jpg'), false); ?>" alt="<?php echo e(__('messages.t_fake_name_ricky_jones'), false); ?>" class="object-cover w-12 h-12 lazy">
							</div>
							<div>
								<div class="font-semibold text-primary-600 hover:text-primary-400">
									<?php echo e(__('messages.t_fake_name_ricky_jones'), false); ?>

								</div>
								<p class="text-gray-500 font-medium text-sm">
									<?php echo e(__('messages.t_graphic_designer'), false); ?>
			...
			<div class="border rounded-md bg-white dark:bg-zinc-800 dark:border-zinc-700 shadow-sm relative">
				...
				<div class="px-4 pt-14 pb-6 sm:px-6 sm:pb-6 relative">
					<blockquote>
						...
						<footer class="flex items-center space-x-4 rtl:space-x-reverse">
							<div class="flex-none rounded-full overflow-hidden w-12 h-12 transform transition ease-out duration-150 dark:hover:bg-zinc-700 hover:shadow-md hover:scale-125 active:shadow-sm active:scale-110">
								<img src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(url('public/img/start_selling/8.jpg'), false); ?>" alt="<?php echo e(__('messages.t_fake_name_melissa_ross'), false); ?>" class="object-cover w-12 h-12 lazy">
							</div>
							<div>
								<div class="font-semibold text-primary-600 hover:text-primary-400">
									<?php echo e(__('messages.t_fake_name_melissa_ross'), false); ?>

								</div>
								<p class="text-gray-500 font-medium text-sm">
									<?php echo e(__('messages.t_music_producer'), false); ?>
...
</div><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/become/seller.blade.php ENDPATH**/ ?>