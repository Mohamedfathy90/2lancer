        ...
        <nav class="relative container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 justify-between items-center h-20 flex">
            ...
            <div class="w-full hidden lg:block">   
                <div class="relative max-w-md" x-data="{ open: false }">
                    ...
                    <input wire:model.debounce.500ms="q" wire:keydown.enter="enter" x-ref="search" x-on:click="open = true" type="search" class="block p-2.5 w-full z-20 text-sm text-gray-900 dark:text-white bg-white dark:bg-[#181818] rounded border border-gray-300 dark:border-[#181818] focus:ring-0 focus:border-gray-500 h-10" placeholder="<?php echo e(__('messages.t_what_service_are_u_looking_for_today'), false); ?>" required>
                    ...
                    <div 
                        ...
                        <div class="bg-white dark:bg-zinc-800 ring-1 ring-black ring-opacity-5 rounded divide-y divide-gray-100 dark:divide-zinc-400">
                            <div class="p-2 space-y-1">
                                ...
                                <a href="<?php echo e(url('search'), false); ?>" role="menuitem" class="w-full flex items-center rounded py-2 px-3 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700 dark:text-zinc-400 dark:hover:bg-zinc-500 dark:hover:text-zinc-200">
                                    <span><?php echo app('translator')->get('messages.t_explore_gigs'); ?></span>
                                </a>

                                
                                <?php if(settings('projects')->is_enabled): ?>
                                    <a href="<?php echo e(url('explore/projects'), false); ?>" role="menuitem" class="w-full flex items-center rounded py-2 px-3 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700 dark:text-zinc-400 dark:hover:bg-zinc-500 dark:hover:text-zinc-200">
...
} elseif ($_instance->childHasBeenRendered('l839187576-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l839187576-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l839187576-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l839187576-0');
} else {
    $response = \Livewire\Livewire::mount('main.partials.languages');
    $html = $response->html();
    $_instance->logRenderedChild('l839187576-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php endif; ?>
                ...
                <?php if(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(url('start_selling'), false); ?>" class="text-gray-500 hover:text-primary-600 transition-colors duration-300 py-2 px-4 hidden md:block dark:text-gray-100 dark:hover:text-white">
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <?php elseif(auth()->user()->account_type === 'seller' && Illuminate\Support\Str::of(request()->path())->startsWith('seller')): ?>
                        ...
                        <a href="<?php echo e(url('/'), false); ?>" class="text-primary-600 hover:text-primary-700 transition-colors duration-300 py-2 px-4 hidden lg:block dark:text-gray-100 dark:hover:text-white">
                ...
                <?php if(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(url('auth/login'), false); ?>" class="text-gray-500 hover:text-primary-600 transition-colors duration-300 py-2 px-4 hidden md:block dark:text-gray-100 dark:hover:text-white">
...
} elseif ($_instance->childHasBeenRendered('l839187576-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l839187576-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l839187576-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l839187576-1');
} else {
    $response = \Livewire\Livewire::mount('main.partials.cart');
    $html = $response->html();
    $_instance->logRenderedChild('l839187576-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        ...
                        <div 
                            ...
                            class="absolute top-full ltr:right-0 rtl:left-0 w-60 mt-3 bg-white dark:bg-zinc-800 rounded-lg shadow-md ring-1 ring-gray-900 ring-opacity-5 font-normal text-sm text-gray-900 divide-y divide-gray-100 dark:divide-zinc-700 z-40">
                                ...
                                <p class="py-3 px-3.5 truncate">
                                    ...
                                    <span class="font-semibold dark:text-white"><?php echo money(auth()->user()->balance_available, settings('currency')->code, true); ?></span>
                                </p>
                                ...
                                <div class="py-1.5 px-3.5">
                                    ...
                                    <?php if(auth()->user()->account_type === 'buyer'): ?>
                                        ...
                                        <a href="<?php echo e(url('start_selling'), false); ?>"
                                            ...
                                            <span
                                                class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('messages.t_become_a_seller'), false); ?></span>
                                        </a>
                                    <?php endif; ?>
                                    ...
                                    <?php if(auth()->user()->account_type === 'seller'): ?>
                                        ...
                                        <a href="<?php echo e(url('seller/home'), false); ?>"
                                            ...
                                            <span
                                                class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('messages.t_seller_dashboard'), false); ?></span>
                                        </a>
                                    <?php endif; ?>
                                ...
                                <div class="py-1.5 px-3.5">
                                    ...
                                    <a href="<?php echo e(url('profile', auth()->user()->username), false); ?>"
                                        ...
                                        <span
                                            class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('messages.t_view_profile'), false); ?></span>
                                    </a>
                                    ...
                                    <a href="<?php echo e(url('account/profile'), false); ?>"
                                        ...
                                        <span
                                            class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('messages.t_edit_profile'), false); ?></span>
                                    </a>
                                    ...
                                    <a href="<?php echo e(url('account/settings'), false); ?>"
                                        ...
                                        <span
                                            class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('messages.t_account_settings'), false); ?></span>
                                    </a>
                                    ...
                                    <a href="<?php echo e(url('account/password'), false); ?>"
                                        ...
                                        <span class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('messages.t_update_password'), false); ?></span>
                                    </a>
                                ...
                                <div class="py-1.5 px-3.5">
                                    ...
                                    <a href="<?php echo e(url('account/deposit'), false); ?>" class="group flex items-center py-1.5 group-hover:text-primary-600">
                                        ...
                                        <span class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('messages.t_deposit'), false); ?></span>
                                    </a>
                                    ...
                                    <a href="<?php echo e(url('account/orders'), false); ?>"
                                        ...
                                        <span
                                            class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('messages.t_my_orders'), false); ?></span>
                                    </a>
                                    ...
                                    <a href="<?php echo e(url('inbox'), false); ?>"
                                        ...
                                        <span
                                            class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('messages.t_messages'), false); ?></span>
                                    </a>
                                    ...
                                    <a href="<?php echo e(url('account/reviews'), false); ?>" class="group flex items-center py-1.5 group-hover:text-primary-600">
                                        ...
                                        <span class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('messages.t_reviews'), false); ?></span>
                                    </a>
                                    ...
                                    <a href="<?php echo e(url('account/refunds'), false); ?>" class="group flex items-center py-1.5 group-hover:text-primary-600">
                                        ...
                                        <span class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('messages.t_refunds'), false); ?></span>
                                    </a>
                                    
                                    
                                    <a href="<?php echo e(url('account/affiliate'), false); ?>"
                                     class="group flex items-center py-1.5 group-hover:text-primary-600">
                                    <svg class=" flex-none ltr:mr-3 rtl:ml-3 text-gray-400 group-hover:text-primary-600 h-5 w-5" 
                                    xmlns="http://www.w3.org/2000/svg" fill="none" height="20" viewBox="0 0 40 40" width="20"><path d="m10.9764 21.1012-1.90257-7.9908m8.19787 9.6178 12.0927-12.0926m-4.1978 20.1977-6.3333-1.6666m.3333-1.6667c0 3.6819-2.9848 6.6667-6.6667 6.6667-3.68186 0-6.66663-2.9848-6.66663-6.6667s2.98477-6.6667 6.66663-6.6667c3.6819 0 6.6667 2.9848 6.6667 6.6667zm-7.5-17.5c0 1.8409-1.4924 3.3333-3.33333 3.3333-1.84095 0-3.33333-1.4924-3.33333-3.3333 0-1.84095 1.49238-3.33333 3.33333-3.33333 1.84093 0 3.33333 1.49238 3.33333 3.33333zm23.3333-1.66667c0 1.84097-1.4924 3.33337-3.3333 3.33337-1.841 0-3.3333-1.4924-3.3333-3.33337 0-1.84095 1.4923-3.33333 3.3333-3.33333 1.8409 0 3.3333 1.49238 3.3333 3.33333zm-3.3333 23.33337c0 1.8409-1.4924 3.3333-3.3333 3.3333-1.841 0-3.3334-1.4924-3.3334-3.3333 0-1.841 1.4924-3.3334 3.3334-3.3334 1.8409 0 3.3333 1.4924 3.3333 3.3334z" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></svg>
                                    <span class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"> <?php echo e(__('messages.t_affiliate'), false); ?> </span> 
                                    </a>
                                ...
                                <div class="py-1.5 px-3.5">
                                    ...
                                    <?php if(auth()->user()->status !== 'verified'): ?>
                                        <a href="<?php echo e(url('account/verification'), false); ?>"
                                            ...
                                            <span
                                                class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('messages.t_verification_center'), false); ?></span>
                                        </a>
                                    <?php endif; ?>
                                    ...
                                    <a href="<?php echo e(url('auth/logout'), false); ?>"
                                        ...
                                        <span
                                            class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('messages.t_logout'), false); ?></span>
                                    </a>
            ...
            <ul class="relative flex items-center justify-between overflow-y-auto transition-colors duration-300 space-x-5 rtl:space-x-reverse scrollbar-thin scrollbar-thumb-gray-400 dark:scrollbar-thumb-zinc-600 scrollbar-track-gray-50 dark:scrollbar-track-zinc-400">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="inline-block flex-shrink-0 border-b-2 border-transparent hover:border-primary-600 focus:outline-none focus:ring-0 relative">
                        ...
                        <?php echo app('translator')->get('messages.t_'.$category->name); ?>
                        </button>
                        <?php else: ?>
                                ...
                                <li class="first:rounded-t-md">
                                    <a href="<?php echo e(url('categories/' . $category->slug . '/' . $sub->slug), false); ?>" class="flex items-center py-2 px-3 hover:bg-gray-50 dark:hover:bg-zinc-700" style="border-radius: inherit">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <?php echo app('translator')->get('messages.t_'.$sub->name); ?>
                                            </p>
                                        </div>
                                    </a>
                                </li>
...
<?php endif; ?>
 ...
 <?php $__env->stopPush(); ?>
 <?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/includes/header.blade.php ENDPATH**/ ?>