...
} elseif ($_instance->childHasBeenRendered('B7xOyWq')) {
    $componentId = $_instance->getRenderedChildComponentId('B7xOyWq');
    $componentTag = $_instance->getRenderedChildComponentTagName('B7xOyWq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('B7xOyWq');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('B7xOyWq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('u2zBI6y')) {
    $componentId = $_instance->getRenderedChildComponentId('u2zBI6y');
    $componentTag = $_instance->getRenderedChildComponentTagName('u2zBI6y');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('u2zBI6y');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('u2zBI6y', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>