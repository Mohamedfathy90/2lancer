    ...
    <div class="grid grid-cols-1 md:grid-cols-3 md:gap-5">
        ...
        <div class="bg-white shadow rounded-lg divide-y divide-gray-200 dark:divide-zinc-700 md:col-span-2 h-fit">
            <div class="py-10 px-12">
                ...
                <div class="mb-14">
                    <h2 class="text-sm leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_create_projects_category'), false); ?></h2>
                </div>
                    ...
                    <?php $__currentLoopData = $translations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <li class="p-4 flex justify-between items-center" wire:key="translations-<?php echo e($key, false); ?>">
                            <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                ...
                                <?php if($language): ?>
                                    <img src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(url('public/img/flags/rounded/' . $language->country_code . '.svg'), false); ?>" alt="<?php echo e($language->name, false); ?>" class="lazy inline-block w-10 h-10 rounded-full" />
                                <?php endif; ?>
...
</div>    <?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/projects/categories/options/create.blade.php ENDPATH**/ ?>