        ...
        <div class="col-span-12 lg:col-span-8">
            <div class="bg-white shadow rounded-lg mb-6">
                ...
                <div class="w-full mb-8 px-6 pb-8">
                    ...
                    <code class="block text-xs text-[#BFC7D5] bg-[#292D3E] px-4 leading-6 py-3"><span class="text-amber-500">curl</span> <?php echo e(url('tasks/schedule'), false); ?></code>

                    
                    <code class="block text-xs text-[#BFC7D5] bg-[#292D3E] px-4 leading-6 py-3"><span class="text-amber-500">curl</span> <?php echo e(url('tasks/queue'), false); ?></code>
...
<?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/installation/crontab.blade.php ENDPATH**/ ?>