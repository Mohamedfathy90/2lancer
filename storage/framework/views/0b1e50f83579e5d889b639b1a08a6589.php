        ...
        <table class="w-full whitespace-nowrap old-tables">
            <thead class="bg-gray-200">
                <tr tabindex="0" class="focus:outline-none h-16 w-full text-sm leading-none text-gray-800 dark:text-white">
                    ...
                    <th class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider ltr:text-left ltr:pl-4 rtl:text-right rtl:pr-4"><?php echo e(__('messages.t_message'), false); ?></th>
                    <th class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider text-center"><?php echo e(__('messages.t_rating'), false); ?></th>
                ...
                <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($review->user && $review->gig): ?>
                        <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white dark:bg-zinc-600 hover:bg-gray-100 dark:hover:bg-zinc-700 border-b border-t border-gray-100 dark:border-zinc-700/40" wire:key="reviews-<?php echo e($review->id, false); ?>">
                            ...
                            <td class="ltr:pl-4 rtl:pr-4">
                                <a href="<?php echo e(url('service', $review->gig->slug), false); ?>" target="_blank" class="flex items-center">
                                    ...
                                    <div class="ltr:pl-4 rtl:pr-4">
                                        <p class="font-medium text-xs"><?php echo e($review->gig->title, false); ?></p>
                            ...
                            <td class="ltr:pl-4 rtl:pr-4">
                                <a href="<?php echo e(url('profile', $review->user->username), false); ?>" target="_blank" class="flex items-center">
                                    <div class="w-8 h-8">
                                        <img class="w-full h-full rounded object-cover lazy" src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src($review->user->avatar), false); ?>" alt="<?php echo e($review->user->username, false); ?>" />
                                    </div>
                                    <div class="ltr:pl-4 rtl:pr-4">
                                        <p class="font-medium text-xs"><?php echo e($review->user->username, false); ?></p>
                                        <p class="text-[11px] leading-3 text-gray-600 pt-2"><?php echo e($review->user->email, false); ?></p>
                                    </div>
                                </a>
                            </td>
                            ...
                            <td class="ltr:pl-4 rtl:pr-4">
                                <?php if($review->message): ?>
                                    <span class="text-xs font-medium"><?php echo e($review->message, false); ?></span>
                                <?php else: ?>
                                ...
                                <div class="relative inline-block text-left">
                                    ...
                                    <div id="table-options-dropdown-<?php echo e($review->id, false); ?>" class="hidden z-40 origin-top-right absolute right-0 mt-2 w-44 rounded-md shadow-lg bg-white dark:bg-zinc-800 ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 dark:divide-zinc-700 focus:outline-none" role="menu"  aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                        <div class="py-1" role="none">
                                            ...
                                            <button x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_delete_this'), false); ?>') ? $wire.delete('<?php echo e($review->id, false); ?>') : ''" wire:loading.attr="disabled" wire:target="delete('<?php echo e($review->id, false); ?>')" type="button" class="text-gray-800 dark:text-gray-300 dark:hover:text-gray-400 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" >
...
</div><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/admin/reviews/reviews.blade.php ENDPATH**/ ?>