                ...
                <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
                    ...
                    <div class="w-full">
                        ...
                        <div class="mb-14 py-6 px-4 sm:p-4">
                            <h2 class="text-base leading-6 font-bold text-gray-900 dark:text-gray-100"><?php echo e(__('messages.t_favorite_list'), false); ?></h2>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300"><?php echo e(__('messages.t_favorite_list_subtitle'), false); ?></p>
                        </div>
...
</main><?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/livewire/main/account/favorite/favorite.blade.php ENDPATH**/ ?>