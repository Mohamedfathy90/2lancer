...
<body class="h-full">
    ...
    <div class="bg-gray-50 min-h-full px-4 py-16 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8">
        <div class="max-w-max mx-auto">
            <main class="sm:flex">
                <p class="text-4xl font-extrabold text-primary-600 sm:text-5xl">429</p>
                <div class="sm:ml-6">
                    <div class="sm:border-l sm:border-gray-200 sm:pl-6">
                        <h1 class="text-2xl font-extrabold text-gray-900 sm:text-3xl uppercase tracking-widest">
                            <?php echo app('translator')->get('messages.t_too_many_requests'); ?>
                        </h1>
                        <p class="mt-1 text-base text-gray-500">
                            <?php echo app('translator')->get('messages.t_u_have_sent_too_many_requests_time'); ?>
                        </p>
                    </div>
...
<?php /**PATH /home/u100719507/domains/2lancer.ma/public_html/resources/views/errors/429.blade.php ENDPATH**/ ?>