...
class StripeController extends Controller
{
    ...
    public function callback(Request $request)
    {
        try {
            ...
            // Get transaction id
            $transaction_id = $request->get('payment_intent');
            ...
            if ( $transaction_id && $action ) {
                ...
                if ( is_array($response) && $response['success'] === TRUE) {
                    ...
                    // Get order id
                    $order_id = $request->get('payment_intent_client_secret');
                    ...
                    if ($action === "D") {
                        ...
                        $this->deposit($data->user_id, $data->amount, $response['response']->id);
                    ...
                    if ($action === "G") {
                        ...
                        // Handle deposit callback
                        $this->checkout($cart, $user, $response['response']->id);
