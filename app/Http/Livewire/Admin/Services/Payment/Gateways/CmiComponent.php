...
class CmiComponent extends Component
{
    ...
    public function mount()
    {
        ...
        if ($settings && $settings->percentage_fee && $settings->settings && $settings->fixed_fee) {
            ...
            // Fill api settings
            $this->fill([
                'client_id' => isset($api_settings['client_id']) ? $api_settings['client_id'] : null,
                'store_key' => isset($api_settings['store_key']) ? $api_settings['store_key'] : null,
            ]);
