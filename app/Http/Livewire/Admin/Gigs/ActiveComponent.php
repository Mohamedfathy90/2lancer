...
class ActiveComponent extends Component
{
    ...
    {
         // Seo
         $this->seo()->setTitle( setSeoTitle(__('messages.t_active_gigs'), true) );
         $this->seo()->setDescription( settings('seo')->description );
        
         $this->gigs = Gig::where('status','active')->paginate(42);
        
        return view('livewire.admin.gigs.active-component',['gigs'=>$this->gigs])->extends('livewire.admin.layout.app')->section('content');
    }
