...
class PendingComponent extends Component
{
    ...
    {
         // Seo
         $this->seo()->setTitle( setSeoTitle(__('messages.t_pending_gigs'), true) );
         $this->seo()->setDescription( settings('seo')->description );
        
         $this->gigs = Gig::where('status','pending')->paginate(42);
        
        return view('livewire.admin.gigs.pending-component',['gigs'=>$this->gigs])->extends('livewire.admin.layout.app')->section('content');
    }
