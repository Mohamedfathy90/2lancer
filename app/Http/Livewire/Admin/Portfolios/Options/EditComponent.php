...
namespace App\Http\Livewire\Admin\Portfolios\Options;
...
class EditComponent extends Component
{
    ...
    public function mount($id)
    {
        ...
        // Get project
        $project       = UserPortfolio::where('uid', $id)->firstOrFail();
    ...
    {
        return view('livewire.admin.portfolios.options.edit')->extends('livewire.admin.layout.app')->section('content');
    }
    ...
    public function update()
    {
        try {
            ...
            // Get project
            $project = UserPortfolio::where('id', $this->project->id)->firstOrFail();
            ...
            return redirect('dashboard/portfolios')->with('success', __('messages.t_project_updated_successfully'));
