...
class SettingsComponent extends Component
{
    ...
    public $paypal_email;
    public $offline_info;
    public $caixabank_info; // تعريف المتغير
    ...
    public function mount()
    {
        ...
        } else if ($payout_account->gateway_provider_name === 'caixabank') {
            
            // Set caixabank info
            $this->caixabank_info = $payout_account->gateway_provider_id;
            $this->selected     = 'caixabank';
    ...
    public function update($selected)
    {
        try {
            ...
            } else if (boolval(config('payouts.caixabank.enabled')) && $selected === 'caixabank' && $this->caixabank_info) {
                
                // Save settings
                UserWithdrawalSettings::where('user_id', auth()->id())->update([

                    'gateway_provider_id'   => $this->caixabank_info,
                    'gateway_provider_name' => 'caixabank'
