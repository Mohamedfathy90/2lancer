    ...
    public function confirm()
    {
        try {
            ...
            if ($selected) {
                ...
                // Set amount
                $amount = convertToNumber(number_format($amount * $selected?->exchange_rate / settings('currency')->exchange_rate, 2, '.', ''));
