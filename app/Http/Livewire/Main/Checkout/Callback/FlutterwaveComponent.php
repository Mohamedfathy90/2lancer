...
{    
    ...
    public function mount()
    {
        try {
            ...
            $gateway_currency_exchange = (float)settings('flutterwave')->exchange_rate;
            ...
            if ( is_array($payment) && $payment['status'] === 'success' ) {
                ...
                // Check currency
                if (strtolower($currency) != strtolower(settings('flutterwave')->currency)) {
                ...
                // Place order 
                $response = $this->checkout($payment);
