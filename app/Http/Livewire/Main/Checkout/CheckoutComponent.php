            ...
            if ($selected) {
                ...
                switch ($this->selected_method) {
                    ...
                    case 'freekassa':
                        ...
                        $params['oa']       = $amount;
                        $params['o']        = 88 . rand(10000000,99999999);
                        $params['i']        = 1;
                    ...
                    case 'paymob':
                        ...
                        if (isset($auth['token'])) {
                            ...
                            if (isset($order['id'])) {
                                ...
                                // Save webhook details to later response
                                $this->webhook(['payment_id' => "GG" . $order['id'], 'payment_method' => 'paymob']);
    ...
    public function wallet()
    {
        try {
            ...
            if($affiliate_register){
                ...
                $referral_earning = (convertToNumber(settings('affiliate')->profit_percentage)/100)*$this->total ;
