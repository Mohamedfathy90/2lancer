...
class HomeComponent extends Component
{
    ...
    {
          $rated_gigs  = Gig::where('counter_reviews','>',0)->active()->orderByDesc('rating')->get(); 
          $random_gigs = Gig::where('counter_reviews',0)->active()->inRandomOrder()->get();                  
          $result_gigs = [];
            ...
            $gigs = Gig::whereIn('id', $result_gigs)->orderByRaw("FIELD(id, $order)")->take(4)->get(); 
