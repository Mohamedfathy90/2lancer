    ...
    <head>
		...
		@if (settings('hero')->enable_bg_img)
            ...
            @if (config()->get('direction') === 'rtl') 
                <link rel="preload prefetch" as="image" href='{{url("/public/storage/site/hero/hero_medium_rtl.jpg")}}' type="image/webp" />
                 @else 
            ...
            @if (config()->get('direction') === 'rtl') 
                <link rel="preload prefetch" as="image" href='{{url("/public/storage/site/hero/hero_large_rtl.jpg")}}' type="image/webp" />
                @else                
        ...
        <!-- Google tag (gtag.js) -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-78K1EYH6ES"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());
        
          gtag('config', 'G-78K1EYH6ES');
        </script>
