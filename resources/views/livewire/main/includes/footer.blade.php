            ...
            <div>
                <div class="flex items-center space-x-2 rtl:space-x-reverse">
                    ...
                    {{-- tiktok --}}
                     ...
                     @if (settings('footer')->social_tiktok)
                         <a href="{{ settings('footer')->social_tiktok }}" target="_blank" data-tooltip-target="tooltip-follow-us-tiktok" class="w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-zinc-600 rounded-md group">
                        ...
                        <div id="tooltip-follow-us-tiktok" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                            {{ __('messages.t_follow_us_on_tiktok') }}
                        </div>
                    @endif
