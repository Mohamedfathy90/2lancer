    ...
    <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            <div class="mb-12 sm:flex items-center justify-between">
                <h2 class="text-sm leading-6 font-bold text-gray-900">{{ __('messages.t_create_permission') }}</h2>
                <div>
            ...
            <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                ...
                <div class="col-span-12">
                    <x-forms.text-input
                        label="{{ __('messages.t_permission_name') }}" 
                        placeholder="{{ __('messages.t_enter_permission_name') }}" 
                        model="name"
                        icon="format-title" />
                </div>
