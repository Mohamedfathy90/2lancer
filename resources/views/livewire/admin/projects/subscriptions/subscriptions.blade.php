            ...
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <h2 class="text-lg font-bold leading-7 text-zinc-700 dark:text-gray-50 sm:truncate sm:text-xl sm:tracking-tight">
                        @lang('messages.t_projects_subscriptions')
                    </h2>
            ...
            <table class="w-full text-left border-spacing-y-[10px] border-separate -mt-2">
                ...
                <thead>
                    @forelse ($subscriptions as $s)
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="admin-dashboard-projects-subscriptions-{{ str_replace('-', '_', $s->uid) }}">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-52 rtl:text-right">
                                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                    ...
                                    {{-- Client --}}
                                    <a href="{{ admin_url('users/details/' . $s->project->client->uid) }}" class="h-10 w-10">
                                        <img class="w-full h-full rounded-md object-cover lazy" src="{{ placeholder_img() }}" data-src="{{ src($s->project->client->avatar) }}" alt="{{ $s->project->client->username }}">
                                    </a>
                                    ...
                                    <div>
                                        ...
                                        {{-- Title --}}
                                        <a href="{{ url('project/' . $s->project->pid . '/' . $s->project->slug) }}" target="_blank" class="font-medium whitespace-nowrap truncate block max-w-[240px] hover:text-primary-600 dark:text-white text-sm" title="{{ $s->project->title }}">
                                            {{ $s->project->title }}
                                        </a>
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                <div class="flex items-center justify-center space-x-4 rtl:space-x-reverse">
                                    ...
                                    {{-- Delete --}}
                                    @can('delete_project_subscription')
                                    <div>
