...
<nav class="w-full {{ $class ? $class : '' }}">
    ...
    <div class="border-b border-gray-100 dark:border-zinc-600">
        ...
        {{-- Affiliate --}}
        <a href="{{ url('account/affiliate') }}"
            class="{{ Request::is('account/affiliate') ? $link_active_class : $link_basic_class }} group ltr:border-l-4 rtl:border-r-4 px-5 py-3 flex items-center text-sm font-medium">

            {{-- icon --}}
            <svg class="{{ Request::is('account/affiliate') ? $icon_active_class : $icon_basic_class }} flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5" 
            ...
            {{-- text --}}
            <span class="truncate text-sm font-semibold"> {{ __('messages.t_affiliate') }} </span>
