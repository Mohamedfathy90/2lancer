...
<div id="{{ $id }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto fixed top-0 right-0 left-0 z-10 w-full md:inset-0 h-modal md:h-full" wire:ignore.self x-data="window.{{ $uid }}" x-init="initialize">
